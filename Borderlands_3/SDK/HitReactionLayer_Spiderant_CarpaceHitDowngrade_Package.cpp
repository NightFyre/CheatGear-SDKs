...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0178F8F0
	 * 		Name   -> Function HitReactionLayer_Spiderant_CarpaceHitDowngrade.HitReactionLayer_Spiderant_CarpaceHitDowngrade_C.EvaluateTag
	...
	class UHitReactionTag* UHitReactionLayer_Spiderant_CarpaceHitDowngrade_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HitReactionLayer_Spiderant_CarpaceHitDowngrade.HitReactionLayer_Spiderant_CarpaceHitDowngrade_C.EvaluateTag");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UHitReactionLayer_Spiderant_CarpaceHitDowngrade_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UHitReactionLayer_Spiderant_CarpaceHitDowngrade_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass HitReactionLayer_Spiderant_CarpaceHitDowngrade.HitReactionLayer_Spiderant_CarpaceHitDowngrade_C");
		return ptr;
	}
