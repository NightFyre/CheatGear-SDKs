...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x02C34720
	 * 		Name   -> Function AIModule.BlackboardComponent.HasValue
	 * 		Flags  -> (Final, Native, Public, HasOutParms, BlueprintCallable, BlueprintPure, Const)
	 * Parameters:
	 * 		class FName                                        KeyName                                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	bool UBlackboardComponent::HasValue(const class FName& KeyName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AIModule.BlackboardComponent.HasValue");
	 ...
	 * Function:
	 * 		RVA    -> 0x02C33D50
	 * 		Name   -> Function AIModule.BlackboardComponent.AddRuntimeKey
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable)
	 * Parameters:
	 ...
	 */
	unsigned char UBlackboardComponent::AddRuntimeKey(const class FName& KeyName, class UBlackboardKeyType* KeyType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AIModule.BlackboardComponent.AddRuntimeKey");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UEnvQueryItemType_Component.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UEnvQueryItemType_Component::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class AIModule.EnvQueryItemType_Component");
		return ptr;
	}
