...
namespace CG
{
	 ...
	 * Size -> 0x0068 (FullSize[0x0798] - InheritedSize[0x0730])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_RGSX[0x4];                                   // 0x0784(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_DroneProj_TED_TenGallon(int32_t EntryPoint);
