...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_BATI[0x6];                                   // 0x078A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnExplode();
		void ExecuteUbergraph_Proj_MAL_SM_Cutsman_Split(int32_t EntryPoint);
