...
namespace CG
{
	...
	public:
		...
		void Obj_Encounter3_KillSpawner(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		...
		void ExecuteUbergraph_Mission_ProvingGrounds_Mission07(int32_t EntryPoint);
