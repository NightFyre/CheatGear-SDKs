...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0178F8F0
	 * 		Name   -> Function BP_GM_Payload_Ringer.BP_GM_Payload_Ringer_C.K2_GrenadeBeginPlay
	...
	void UBP_GM_Payload_Ringer_C::K2_GrenadeBeginPlay(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod, struct FPayloadInstanceData* InstanceData)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Ringer.BP_GM_Payload_Ringer_C.K2_GrenadeBeginPlay");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_GM_Payload_Ringer_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UBP_GM_Payload_Ringer_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_GM_Payload_Ringer.BP_GM_Payload_Ringer_C");
		return ptr;
	}
