...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DO43[0x4];                                   // 0x033C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Challenge_Crew_Ger_Cemetery_00_AllComplete(int32_t EntryPoint);
