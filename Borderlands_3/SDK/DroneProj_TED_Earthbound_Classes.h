...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_EPHA[0x4];                                   // 0x078C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_DroneProj_TED_Earthbound(int32_t EntryPoint);
