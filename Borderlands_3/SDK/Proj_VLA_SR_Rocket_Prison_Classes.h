...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_5I9Y[0x6];                                   // 0x078A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnExplode();
		void ExecuteUbergraph_Proj_VLA_SR_Rocket_Prison(int32_t EntryPoint);
