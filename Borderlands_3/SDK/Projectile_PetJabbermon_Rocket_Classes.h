...
namespace CG
{
	 ...
	 * Size -> 0x0038 (FullSize[0x0718] - InheritedSize[0x06E0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_IAES[0x4];                                   // 0x070C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnExplode();
		void ExecuteUbergraph_Projectile_PetJabbermon_Rocket(int32_t EntryPoint);
