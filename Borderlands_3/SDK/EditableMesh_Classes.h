...
namespace CG
{
	 ...
	 * Size -> 0x1048 (FullSize[0x1070] - InheritedSize[0x0028])
	 */
	class UEditableMesh : public UObject
	{
	public:
		unsigned char                                              UnknownData_L9HN[0xD50];                                 // 0x0028(0x0D50) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UEditableMeshAdapter*>                        Adapters;                                                // 0x0D78(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		int32_t                                                    TextureCoordinateCount;                                  // 0x0D88(0x0004) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_KGZI[0xF8];                                  // 0x0D8C(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    PendingCompactCounter;                                   // 0x0E84(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		int32_t                                                    SubdivisionCount;                                        // 0x0E88(0x0004) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_TYT9[0x1E4];                                 // 0x0E8C(0x01E4) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SNJS[0xA4];                                  // 0x003C(0x00A4) MISSED OFFSET (PADDING)
