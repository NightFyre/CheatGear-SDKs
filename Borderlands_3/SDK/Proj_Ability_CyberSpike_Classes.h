...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_32LJ[0x6];                                   // 0x078A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Proj_Ability_CyberSpike(int32_t EntryPoint);
