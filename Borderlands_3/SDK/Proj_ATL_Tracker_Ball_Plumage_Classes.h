...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Q27L[0x4];                                   // 0x0A04(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FWwisePlaybackInstance                              ProjAudio;                                               // 0x0A08(0x0018) Edit, BlueprintVisible, DisableEditOnInstance

	public:
		void AOE_FindTarget();
		void UserConstructionScript();
		void GbxAsyncRequest_Spawned_EC7096D84CE43BFCBCFD209C516EA52E(class AActor* Actor, int32_t InstanceIndex);
		void OnExplode();
		...
		void MultiTargetTag();
		void ExecuteUbergraph_Proj_ATL_Tracker_Ball_Plumage(int32_t EntryPoint);
