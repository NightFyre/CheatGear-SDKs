...
namespace CG
{
	 ...
	 */
	struct UInit_Season01_MissionDropCondition_Repeatable_C_CalculateAttributeInitialValue_Params
	{
	public:
		...
		unsigned char                                              UnknownData_0DYW[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
