...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_2UAY[0x4];                                   // 0x070C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnExplode();
		void ExecuteUbergraph_Projectile_PetSkag_RangedAttack(int32_t EntryPoint);
