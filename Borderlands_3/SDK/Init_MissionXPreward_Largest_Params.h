...
namespace CG
{
	 ...
	 */
	struct UInit_MissionXPreward_Largest_C_CalculateAttributeInitialValue_Params
	{
	public:
		...
		unsigned char                                              UnknownData_598R[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
