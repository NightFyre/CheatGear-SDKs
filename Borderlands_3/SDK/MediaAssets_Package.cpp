...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UMediaAudioSinkProviderInterface.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UMediaAudioSinkProviderInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MediaAssets.MediaAudioSinkProviderInterface");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x02AADD20
	 * 		Name   -> Function MediaAssets.MediaPlayer.SetAudioSinkProvider
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable)
	 */
	void UMediaPlayer::SetAudioSinkProvider()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MediaAssets.MediaPlayer.SetAudioSinkProvider");
