...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KEBE[0x4];                                   // 0x0A04(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Proj_ATL_Tracker_Ball(int32_t EntryPoint);
