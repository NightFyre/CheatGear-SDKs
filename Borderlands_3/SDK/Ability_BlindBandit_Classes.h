...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_J0T8[0x4];                                   // 0x01F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnDeactivated();
		void ExecuteUbergraph_Ability_BlindBandit(int32_t EntryPoint);
