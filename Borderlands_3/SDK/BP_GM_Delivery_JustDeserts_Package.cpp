...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0178F8F0
	 * 		Name   -> Function BP_GM_Delivery_JustDeserts.BP_GM_Delivery_JustDeserts_C.K2_GrenadeExplode
	...
	void UBP_GM_Delivery_JustDeserts_C::K2_GrenadeExplode(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_GM_Delivery_JustDeserts.BP_GM_Delivery_JustDeserts_C.K2_GrenadeExplode");
	 ...
	 * Function:
	 * 		RVA    -> 0x0178F8F0
	 * 		Name   -> Function BP_GM_Delivery_JustDeserts.BP_GM_Delivery_JustDeserts_C.K2_GrenadeInitialized
	 * 		Flags  -> (Event, Public, BlueprintCallable, BlueprintEvent, Const)
	 * Parameters:
	 * 		class AGrenade*                                    Grenade                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		class AGrenadeMod*                                 GrenadeMod                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void UBP_GM_Delivery_JustDeserts_C::K2_GrenadeInitialized(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_GM_Delivery_JustDeserts.BP_GM_Delivery_JustDeserts_C.K2_GrenadeInitialized");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_GM_Delivery_JustDeserts_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UBP_GM_Delivery_JustDeserts_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_GM_Delivery_JustDeserts.BP_GM_Delivery_JustDeserts_C");
		return ptr;
	}
