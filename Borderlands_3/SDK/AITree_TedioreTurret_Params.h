...
namespace CG
{
	 ...
	 */
	struct UAITree_TedioreTurret_C_BndEvt__Priority_Shoot_or_Walk.BlackboardKey_OnStartedEventBP_AIActionBlueprintDelegate__DelegateSignature_AITree_TedioreTurret_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_H2OM[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
