...
namespace CG
{
	 ...
	 */
	struct UInit_Siren_DLCSkill_5_BonusDamage_C_CalculateAttributeInitialValue_Params
	{
	public:
		...
		unsigned char                                              UnknownData_UL78[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
