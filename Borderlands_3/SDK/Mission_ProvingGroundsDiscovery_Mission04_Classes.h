...
namespace CG
{
	...
	public:
		...
		void Obj_NavigateTo_Trial4(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		...
		void ExecuteUbergraph_Mission_ProvingGroundsDiscovery_Mission04(int32_t EntryPoint);
