...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x006305A0
	 * 		Name   -> Function ApexDestruction.DestructibleComponent.SetDestructiblePoseComponent
	...
	void UDestructibleComponent::SetDestructiblePoseComponent(class USkinnedMeshComponent* NewDestructiblePoseComponent)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ApexDestruction.DestructibleComponent.SetDestructiblePoseComponent");
