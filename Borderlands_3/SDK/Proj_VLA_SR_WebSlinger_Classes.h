...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_HI14[0x6];                                   // 0x078A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnExplode();
		void ExecuteUbergraph_Proj_VLA_SR_WebSlinger(int32_t EntryPoint);
