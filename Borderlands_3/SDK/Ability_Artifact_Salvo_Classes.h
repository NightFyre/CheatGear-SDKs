...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1ZNR[0x6];                                   // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void StopFiring();
		void ExecuteUbergraph_Ability_Artifact_Salvo(int32_t EntryPoint);
