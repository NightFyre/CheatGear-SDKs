...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_EPYC[0x5];                                   // 0x020B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0210(0x0008) Transient, DuplicateTransient

	public:
		void AnointAutoBearEnded(bool HasValidTarget, class AActor* ChargeTarget);
		void ExecuteUbergraph_Ability_Gunner_AutoBear_AmmoRegen(int32_t EntryPoint);
