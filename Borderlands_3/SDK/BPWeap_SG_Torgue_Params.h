...
namespace CG
{
	 ...
	 */
	struct ABPWeap_SG_Torgue_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BPWeap_SG_Torgue.BPWeap_SG_Torgue_C.ReceiveBeginPlay
	 */
	struct ABPWeap_SG_Torgue_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BPWeap_SG_Torgue.BPWeap_SG_Torgue_C.HideSpeedLoader
	 */
	struct ABPWeap_SG_Torgue_C_HideSpeedLoader_Params
	{	};

	/**
	 * Function BPWeap_SG_Torgue.BPWeap_SG_Torgue_C.ResetBoneVisibility
	 */
	struct ABPWeap_SG_Torgue_C_ResetBoneVisibility_Params
	{	};
