...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_30WO[0x4];                                   // 0x0524(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void MissionKickoff();
		void ExecuteUbergraph_Mission_DynastyDash_Wetlands_Repeatable(int32_t EntryPoint);
