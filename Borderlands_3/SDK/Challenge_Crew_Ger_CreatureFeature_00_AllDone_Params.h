...
namespace CG
{
	 ...
	 */
	struct UChallenge_Crew_Ger_CreatureFeature_00_AllDone_C_CompletedChallenge_Params
	{
	public:
	 ...
	 */
	struct UChallenge_Crew_Ger_CreatureFeature_00_AllDone_C_ExecuteUbergraph_Challenge_Crew_Ger_CreatureFeature_00_AllDone_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_7NMJ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
