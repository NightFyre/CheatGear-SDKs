...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_5T8K[0x6];                                   // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UIOY[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Ability_Artifact_SparkPlug(int32_t EntryPoint);
