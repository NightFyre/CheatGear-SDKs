...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0178F8F0
	 * 		Name   -> Function BP_GM_Delivery_Fastball.BP_GM_Delivery_Fastball_C.K2_GrenadeInitialized
	...
	void UBP_GM_Delivery_Fastball_C::K2_GrenadeInitialized(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_GM_Delivery_Fastball.BP_GM_Delivery_Fastball_C.K2_GrenadeInitialized");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_GM_Delivery_Fastball_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UBP_GM_Delivery_Fastball_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_GM_Delivery_Fastball.BP_GM_Delivery_Fastball_C");
		return ptr;
	}
