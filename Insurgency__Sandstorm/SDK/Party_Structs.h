...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_69JR[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_47D9[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FUserPlatform                                       Platform;                                                // 0x0020(0x0010) HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_Z2MH[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FUniqueNetIdRepl                                    PlatformUniqueId;                                        // 0x0060(0x0028) HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_IIFP[0x30];                                  // 0x0088(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FString                                              PlatformSessionId;                                       // 0x00B8(0x0010) ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_LHV4[0x30];                                  // 0x00C8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TR1O[0x37];                                  // 0x00F9(0x0037) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_KBKH[0x10];                                  // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2NMC[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_5BP5[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPartyPrivacySettings                               PrivacySettings;                                         // 0x0020(0x0003) NoDestructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_2PZ8[0x35];                                  // 0x0023(0x0035) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NIVB[0x18];                                  // 0x0068(0x0018) MISSED OFFSET (PADDING)
	};
