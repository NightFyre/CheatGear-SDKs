...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQS_GetCoverThreatLocation.EQS_GetCoverThreatLocation_C.ProvideSingleLocation
	 */
	struct UEQS_GetCoverThreatLocation_C_ProvideSingleLocation_Params
	{
	public:
