...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_39_ProximityMeterFireSupport.Lesson_39_ProximityMeterFireSupport_C
	 * Size -> 0x0040 (FullSize[0x0128] - InheritedSize[0x00E8])
	 */
	class ULesson_39_ProximityMeterFireSupport_C : public UTutorialLesson
	{
	public:
		...
		class ABP_Utility_BinocularsBase_C*                        K2Node_DynamicCast_AsBP_Utility_Binoculars_Base;         // 0x0118(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_2QUD[0x7];                                   // 0x0121(0x0007) MISSED OFFSET (PADDING)

	public:
		void OnEquipDelegate_Event_1(class AINSSoldier* bpp__Interactor__pf, class AItemWeapon* bpp__Weapon__pf);
