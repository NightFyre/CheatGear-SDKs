...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_Prop_AirConditioner.BP_Prop_AirConditioner_C
	 * Size -> 0x0058 (FullSize[0x0490] - InheritedSize[0x0438])
	 */
	class ABP_Prop_AirConditioner_C : public APropBreakable
	{
	public:
		...
		unsigned char                                              UnknownData_ODD3[0x3];                                   // 0x0445(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NFIK[0x8];                                   // 0x0488(0x0008) MISSED OFFSET (PADDING)
