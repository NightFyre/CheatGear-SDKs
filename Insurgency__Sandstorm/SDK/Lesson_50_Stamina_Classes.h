...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_50_Stamina.Lesson_50_Stamina_C
	 * Size -> 0x0020 (FullSize[0x0108] - InheritedSize[0x00E8])
	 */
	class ULesson_50_Stamina_C : public UTutorialLesson
	{
	public:
	...
	public:
		...
		void OnShouldHintStaminaDelegate__DelegateSignature();
