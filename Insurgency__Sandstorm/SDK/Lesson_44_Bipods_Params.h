...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_44_Bipods.Lesson_44_Bipods_C.OnEquip
	 */
	struct ULesson_44_Bipods_C_OnEquip_Params
	{
	public:
	...
	/**
	 * Function Lesson_44_Bipods.Lesson_44_Bipods_C.BlueprintOnInitialized
	 */
	struct ULesson_44_Bipods_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_44_Bipods.Lesson_44_Bipods_C.OnWeaponEventDelegate__DelegateSignature
	 */
	struct ULesson_44_Bipods_C_OnWeaponEventDelegate__DelegateSignature_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
