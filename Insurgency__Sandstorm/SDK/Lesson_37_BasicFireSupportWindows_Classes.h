...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_37_BasicFireSupportWindows.Lesson_37_BasicFireSupportWindows_C
	 * Size -> 0x0028 (FullSize[0x0110] - InheritedSize[0x00E8])
	 */
	class ULesson_37_BasicFireSupportWindows_C : public UTutorialLesson
	{
	public:
	...
	public:
		void OnPlayerClassChanged_Event_1(class AINSSoldier* bpp__Player__pf);
