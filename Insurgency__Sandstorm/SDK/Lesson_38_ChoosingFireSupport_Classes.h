...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_38_ChoosingFireSupport.Lesson_38_ChoosingFireSupport_C
	 * Size -> 0x0040 (FullSize[0x0128] - InheritedSize[0x00E8])
	 */
	class ULesson_38_ChoosingFireSupport_C : public UTutorialLesson
	{
	public:
		...
		unsigned char                                              UnknownData_WP36[0x7];                                   // 0x0121(0x0007) MISSED OFFSET (PADDING)
