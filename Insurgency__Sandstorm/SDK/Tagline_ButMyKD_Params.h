...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Tagline_ButMyKD.Tagline_ButMyKD_C.BlueprintOnCheckRoundEndAward
	 */
	struct UTagline_ButMyKD_C_BlueprintOnCheckRoundEndAward_Params
	{
	public:
	...
	/**
	 * Function Tagline_ButMyKD.Tagline_ButMyKD_C.BlueprintInit
	 */
	struct UTagline_ButMyKD_C_BlueprintInit_Params
	{
	public:
