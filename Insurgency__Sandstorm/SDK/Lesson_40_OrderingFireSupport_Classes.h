...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_40_OrderingFireSupport.Lesson_40_OrderingFireSupport_C
	 * Size -> 0x0040 (FullSize[0x0128] - InheritedSize[0x00E8])
	 */
	class ULesson_40_OrderingFireSupport_C : public UTutorialLesson
	{
	public:
		...
		unsigned char                                              UnknownData_OJ3Z[0x7];                                   // 0x0121(0x0007) MISSED OFFSET (PADDING)
