...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_23_DoorPeeking.Lesson_23_DoorPeeking_C
	 * Size -> 0x0030 (FullSize[0x0118] - InheritedSize[0x00E8])
	 */
	class ULesson_23_DoorPeeking_C : public UTutorialLesson
	{
	public:
	...
	public:
		void OnDoorPeekedDelegate_Event_1(class AINSSoldier* bpp__Interactor__pf, class ADoor* bpp__Door__pf);
