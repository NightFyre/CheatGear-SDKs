...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQS_GetActiveArtilleryLandingPoints.EQS_GetActiveArtilleryLandingPoints_C.ProvideLocationsSet
	 */
	struct UEQS_GetActiveArtilleryLandingPoints_C_ProvideLocationsSet_Params
	{
	public:
