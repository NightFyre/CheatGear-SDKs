...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_27_DefendingObjectives.Lesson_27_DefendingObjectives_C.OnObjectiveBeginOverlapDelegate_Event_1
	 */
	struct ULesson_27_DefendingObjectives_C_OnObjectiveBeginOverlapDelegate_Event_1_Params
	{
	public:
	...
	/**
	 * Function Lesson_27_DefendingObjectives.Lesson_27_DefendingObjectives_C.BlueprintOnInitialized
	 */
	struct ULesson_27_DefendingObjectives_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_27_DefendingObjectives.Lesson_27_DefendingObjectives_C.OnObjectiveBeginOverlapDelegate__DelegateSignature
	 */
	struct ULesson_27_DefendingObjectives_C_OnObjectiveBeginOverlapDelegate__DelegateSignature_Params
	{
	public:
		class AINSPlayerController*                                bpp__Capturer__pf;                                       // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AObjectiveBase*                                      bpp__Objective__pf;                                      // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
