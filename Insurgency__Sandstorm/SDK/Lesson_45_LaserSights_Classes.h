...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_45_LaserSights.Lesson_45_LaserSights_C
	 * Size -> 0x0040 (FullSize[0x0128] - InheritedSize[0x00E8])
	 */
	class ULesson_45_LaserSights_C : public UTutorialLesson
	{
	public:
		...
		class UWeaponLightComponent*                               K2Node_DynamicCast_AsWeapon_Light_Component;             // 0x0118(0x0008) ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_GSMA[0x7];                                   // 0x0121(0x0007) MISSED OFFSET (PADDING)
