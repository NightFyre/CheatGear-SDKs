...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_45_LaserSights.Lesson_45_LaserSights_C.OnEquipDelegate_Event_1
	 */
	struct ULesson_45_LaserSights_C_OnEquipDelegate_Event_1_Params
	{
	public:
	...
	/**
	 * Function Lesson_45_LaserSights.Lesson_45_LaserSights_C.BlueprintOnInitialized
	 */
	struct ULesson_45_LaserSights_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_45_LaserSights.Lesson_45_LaserSights_C.OnWeaponEventDelegate__DelegateSignature
	 */
	struct ULesson_45_LaserSights_C_OnWeaponEventDelegate__DelegateSignature_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
