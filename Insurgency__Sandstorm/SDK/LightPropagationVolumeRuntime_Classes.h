...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_G13X[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1RYL[0x4];                                   // 0x0074(0x0004) MISSED OFFSET (PADDING)
