...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9JIW[0x40];                                  // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W0JQ[0x3E0];                                 // 0x00B8(0x03E0) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_U99H[0x8];                                   // 0x04C8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XBOW[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VGW1[0xA8];                                  // 0x0050(0x00A8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NCOD[0xE8];                                  // 0x0050(0x00E8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GLM8[0x30];                                  // 0x00F8(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BR2M[0x98];                                  // 0x00F8(0x0098) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I0JW[0x50];                                  // 0x00F8(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B0BQ[0x48];                                  // 0x00F8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_DF7G[0x1E0];                                 // 0x0050(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AXTL[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_AFLM[0x18];                                  // 0x00F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_CNIV[0x18];                                  // 0x0060(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SQGO[0x140];                                 // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3NAF[0x18];                                  // 0x0178(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PXHD[0x8];                                   // 0x01A0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3DHB[0x80];                                  // 0x01C0(0x0080) MISSED OFFSET (PADDING)
