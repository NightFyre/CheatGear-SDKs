...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_11_Reloading.Lesson_11_Reloading_C.OnReloadDelegate_Event_1
	 */
	struct ULesson_11_Reloading_C_OnReloadDelegate_Event_1_Params
	{
	public:
	...
	/**
	 * Function Lesson_11_Reloading.Lesson_11_Reloading_C.OnDryFireDelegate_Event_1
	 */
	struct ULesson_11_Reloading_C_OnDryFireDelegate_Event_1_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	/**
	 * Function Lesson_11_Reloading.Lesson_11_Reloading_C.BlueprintOnInitialized
	 */
	struct ULesson_11_Reloading_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_11_Reloading.Lesson_11_Reloading_C.OnWeaponEventDelegate__DelegateSignature
	 */
	struct ULesson_11_Reloading_C_OnWeaponEventDelegate__DelegateSignature_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
