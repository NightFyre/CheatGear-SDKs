...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function CC_BASE_FACEWEAR_NeckGaiter.CC_BASE_FACEWEAR_NeckGaiter_C.BlueprintInitCosmetic
	 */
	struct UCC_BASE_FACEWEAR_NeckGaiter_C_BlueprintInitCosmetic_Params
	{
	public:
