...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_32_ShootingWhileDriving.Lesson_32_ShootingWhileDriving_C.OnNewSeat
	 */
	struct ULesson_32_ShootingWhileDriving_C_OnNewSeat_Params
	{
	public:
	...
	/**
	 * Function Lesson_32_ShootingWhileDriving.Lesson_32_ShootingWhileDriving_C.BlueprintOnInitialized
	 */
	struct ULesson_32_ShootingWhileDriving_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_32_ShootingWhileDriving.Lesson_32_ShootingWhileDriving_C.OnNewSeatDelegate__DelegateSignature
	 */
	struct ULesson_32_ShootingWhileDriving_C_OnNewSeatDelegate__DelegateSignature_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class UVehicleSeatComponent*                               bpp__NewSeat__pf;                                        // 0x0008(0x0008)  (Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
