...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_LightLamp_02.BP_LightLamp_02_C
	 * Size -> 0x0048 (FullSize[0x0460] - InheritedSize[0x0418])
	 */
	class ABP_LightLamp_02_C : public ABP_LightBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_R5PB[0x3];                                   // 0x0439(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CZC5[0x6];                                   // 0x045A(0x0006) MISSED OFFSET (PADDING)
