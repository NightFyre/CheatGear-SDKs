...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_LightBulb_03.BP_LightBulb_03_C
	 * Size -> 0x0048 (FullSize[0x0460] - InheritedSize[0x0418])
	 */
	class ABP_LightBulb_03_C : public ABP_LightBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_4HT7[0x3];                                   // 0x0439(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3U2V[0x6];                                   // 0x045A(0x0006) MISSED OFFSET (PADDING)
