...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04F3A890
	 * 		Name   -> Function CC_BASE_HAIR.CC_BASE_HAIR_C.BlueprintInitCosmetic
	 ...
	 */
	void UCC_BASE_HAIR_C::BlueprintInitCosmetic(class UClass* bpp__VariationClass__pf)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function CC_BASE_HAIR.CC_BASE_HAIR_C.BlueprintInitCosmetic");
		
		UCC_BASE_HAIR_C_BlueprintInitCosmetic_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x04F3A640
	 * 		Name   -> Function CC_BASE_HAIR.CC_BASE_HAIR_C.BlueprintCosmeticMeshLoaded
	 ...
	 */
	void UCC_BASE_HAIR_C::BlueprintCosmeticMeshLoaded(class UINSSkeletalMeshComponent* bpp__SkeletalMesh__pf, const struct FCharacterCosmeticAttachedModel& bpp__CosmeticModel__pf__const, bool bpp__bFirstPerson__pf__const, bool bpp__bBodyMesh__pf__const)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function CC_BASE_HAIR.CC_BASE_HAIR_C.BlueprintCosmeticMeshLoaded");
		
		UCC_BASE_HAIR_C_BlueprintCosmeticMeshLoaded_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UCC_BASE_HAIR_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UCC_BASE_HAIR_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("DynamicClass CC_BASE_HAIR.CC_BASE_HAIR_C");
		return ptr;
	}
