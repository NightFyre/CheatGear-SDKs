...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_UG_FamasBipod.BP_UG_FAMASBipod_C
	 * Size -> 0x0008 (FullSize[0x0478] - InheritedSize[0x0470])
	 */
	class UBP_UG_FAMASBipod_C : public UBP_UG_BipodBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_F6XM[0x4];                                   // 0x0474(0x0004) MISSED OFFSET (PADDING)
