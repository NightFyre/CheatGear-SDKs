...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BP_MenuTabsButton.BP_MenuTabsButton_C
	 * Size -> 0x0085 (FullSize[0x02B5] - InheritedSize[0x0230])
	 */
	class UBP_MenuTabsButton_C : public UUserWidget
	{
	public:
		...
		unsigned char                                              UnknownData_2TCA[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_MenuTabsButton(int32_t EntryPoint);
