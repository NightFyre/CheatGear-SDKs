...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_16_Focus.Lesson_16_Focus_C.OnSights
	 */
	struct ULesson_16_Focus_C_OnSights_Params
	{
	public:
	...
	/**
	 * Function Lesson_16_Focus.Lesson_16_Focus_C.OnFocus
	 */
	struct ULesson_16_Focus_C_OnFocus_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	/**
	 * Function Lesson_16_Focus.Lesson_16_Focus_C.BlueprintOnInitialized
	 */
	struct ULesson_16_Focus_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_16_Focus.Lesson_16_Focus_C.OnWeaponEventDelegate__DelegateSignature
	 */
	struct ULesson_16_Focus_C_OnWeaponEventDelegate__DelegateSignature_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
