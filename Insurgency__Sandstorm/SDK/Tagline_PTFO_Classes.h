...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Tagline_PTFO.Tagline_PTFO_C
	 * Size -> 0x0020 (FullSize[0x0100] - InheritedSize[0x00E0])
	 */
	class UTagline_PTFO_C : public UTagline
	{
	public:
		...
		unsigned char                                              UnknownData_2UR8[0x3];                                   // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
