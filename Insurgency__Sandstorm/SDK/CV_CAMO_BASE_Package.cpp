...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04F95AC0
	 * 		Name   -> Function CV_CAMO_BASE.CV_CAMO_BASE_C.BlueprintCosmeticItemMeshLoaded
	 ...
	 */
	void UCV_CAMO_BASE_C::BlueprintCosmeticItemMeshLoaded(class UINSSkeletalMeshComponent* bpp__SkeletalMesh__pf, const struct FCharacterCosmeticAttachedModel& bpp__CosmeticModel__pf__const, bool bpp__bFirstPerson__pf__const, bool bpp__bBodyMesh__pf__const)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function CV_CAMO_BASE.CV_CAMO_BASE_C.BlueprintCosmeticItemMeshLoaded");
		
		UCV_CAMO_BASE_C_BlueprintCosmeticItemMeshLoaded_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UCV_CAMO_BASE_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UCV_CAMO_BASE_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("DynamicClass CV_CAMO_BASE.CV_CAMO_BASE_C");
		return ptr;
	}
