...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_UG_INSBipod_MAK.BP_UG_INSBipod_MAK_C
	 * Size -> 0x0008 (FullSize[0x0478] - InheritedSize[0x0470])
	 */
	class UBP_UG_INSBipod_MAK_C : public UBP_UG_BipodBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_YQ5W[0x4];                                   // 0x0474(0x0004) MISSED OFFSET (PADDING)
