...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function CC_BASE_FACEHAIR.CC_BASE_FACEHAIR_C.BlueprintInitCosmetic
	 */
	struct UCC_BASE_FACEHAIR_C_BlueprintInitCosmetic_Params
	{
	public:
	...
	/**
	 * Function CC_BASE_FACEHAIR.CC_BASE_FACEHAIR_C.BlueprintCosmeticMeshLoaded
	 */
	struct UCC_BASE_FACEHAIR_C_BlueprintCosmeticMeshLoaded_Params
	{
	public:
