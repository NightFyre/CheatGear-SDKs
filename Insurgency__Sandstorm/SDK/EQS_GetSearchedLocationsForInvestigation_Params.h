...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQS_GetSearchedLocationsForInvestigation.EQS_GetSearchedLocationsForInvestigation_C.ProvideLocationsSet
	 */
	struct UEQS_GetSearchedLocationsForInvestigation_C_ProvideLocationsSet_Params
	{
	public:
