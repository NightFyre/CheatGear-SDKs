...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Lesson_09_WeaponMelee.Lesson_09_WeaponMelee_C
	 * Size -> 0x0030 (FullSize[0x0118] - InheritedSize[0x00E8])
	 */
	class ULesson_09_WeaponMelee_C : public UTutorialLesson
	{
	public:
	...
	public:
		void OnMeleeAttackDelegate_Event_1(class AINSSoldier* bpp__Interactor__pf, class AItemWeapon* bpp__Weapon__pf);
