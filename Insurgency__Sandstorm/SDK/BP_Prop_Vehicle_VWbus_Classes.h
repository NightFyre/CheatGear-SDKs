...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_Prop_Vehicle_VWbus.BP_Prop_Vehicle_VWbus_C
	 * Size -> 0x0070 (FullSize[0x03F0] - InheritedSize[0x0380])
	 */
	class ABP_Prop_Vehicle_VWbus_C : public ABP_Prop_Vehicle_Base_C
	{
	public:
		...
		unsigned char                                              UnknownData_IB81[0x2];                                   // 0x03E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void BndEvt__RoundReset_K2Node_ComponentBoundEvent_11_OnRoundResetDelegate__DelegateSignature();
