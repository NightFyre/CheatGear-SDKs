...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_Lantern_Hanging_01.BP_Lantern_Hanging_01_C
	 * Size -> 0x0068 (FullSize[0x0480] - InheritedSize[0x0418])
	 */
	class ABP_Lantern_Hanging_01_C : public ABP_LightBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_JTO3[0x3];                                   // 0x0441(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_T7HR[0x6];                                   // 0x0462(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
