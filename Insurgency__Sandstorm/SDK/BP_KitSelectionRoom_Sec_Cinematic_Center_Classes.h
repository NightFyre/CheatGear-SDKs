...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_KitSelectionRoom_Sec_Cinematic_Center.BP_KitSelectionRoom_Sec_Cinematic_Center_C
	 * Size -> 0x0048 (FullSize[0x0268] - InheritedSize[0x0220])
	 */
	class ABP_KitSelectionRoom_Sec_Cinematic_Center_C : public AActor
	{
	public:
