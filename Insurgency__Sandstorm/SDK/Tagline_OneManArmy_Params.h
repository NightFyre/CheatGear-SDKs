...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Tagline_OneManArmy.Tagline_OneManArmy_C.CheckLastManStanding
	 */
	struct UTagline_OneManArmy_C_CheckLastManStanding_Params
	{
	public:
	...
	/**
	 * Function Tagline_OneManArmy.Tagline_OneManArmy_C.BlueprintOnCheckRoundEndAward
	 */
	struct UTagline_OneManArmy_C_BlueprintOnCheckRoundEndAward_Params
	{
	public:
