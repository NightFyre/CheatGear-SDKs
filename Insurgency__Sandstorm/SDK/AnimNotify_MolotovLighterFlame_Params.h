...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function AnimNotify_MolotovLighterFlame.AnimNotify_MolotovLighterFlame_C.Received_Notify
	 */
	struct UAnimNotify_MolotovLighterFlame_C_Received_Notify_Params
	{
	public:
