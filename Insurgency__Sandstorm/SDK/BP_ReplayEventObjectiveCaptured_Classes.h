...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BP_ReplayEventObjectiveCaptured.BP_ReplayEventObjectiveCaptured_C
	 * Size -> 0x0028 (FullSize[0x0270] - InheritedSize[0x0248])
	 */
	class UBP_ReplayEventObjectiveCaptured_C : public UBP_ReplayEventBase_C
	{
	public:
	...
	public:
		...
		void Construct();
		void ExecuteUbergraph_BP_ReplayEventObjectiveCaptured(int32_t EntryPoint);
