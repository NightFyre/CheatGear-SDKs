...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EnvQueryContext_HelicopterDestination.EnvQueryContext_HelicopterDestination_C.ProvideSingleLocation
	 */
	struct UEnvQueryContext_HelicopterDestination_C_ProvideSingleLocation_Params
	{
	public:
