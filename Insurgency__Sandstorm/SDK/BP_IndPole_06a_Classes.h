...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_IndPole_06a.BP_IndPole_06a_C
	 * Size -> 0x0048 (FullSize[0x0460] - InheritedSize[0x0418])
	 */
	class ABP_IndPole_06a_C : public ABP_LightBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_33JT[0x3];                                   // 0x0449(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZO3H[0x8];                                   // 0x0458(0x0008) MISSED OFFSET (PADDING)
