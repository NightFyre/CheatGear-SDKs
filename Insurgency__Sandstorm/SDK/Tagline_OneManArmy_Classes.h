...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass Tagline_OneManArmy.Tagline_OneManArmy_C
	 * Size -> 0x0010 (FullSize[0x00F0] - InheritedSize[0x00E0])
	 */
	class UTagline_OneManArmy_C : public UTagline
	{
	public:
		...
		unsigned char                                              UnknownData_AWPG[0x7];                                   // 0x00E9(0x0007) MISSED OFFSET (PADDING)
