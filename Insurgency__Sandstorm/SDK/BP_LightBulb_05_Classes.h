...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DynamicClass BP_LightBulb_05.BP_LightBulb_05_C
	 * Size -> 0x0048 (FullSize[0x0460] - InheritedSize[0x0418])
	 */
	class ABP_LightBulb_05_C : public ABP_LightBase_C
	{
	public:
		...
		unsigned char                                              UnknownData_RIL5[0x3];                                   // 0x0439(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VSAK[0x6];                                   // 0x045A(0x0006) MISSED OFFSET (PADDING)
