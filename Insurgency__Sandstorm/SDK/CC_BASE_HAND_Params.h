...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function CC_BASE_HAND.CC_BASE_HAND_C.BlueprintInitCosmetic
	 */
	struct UCC_BASE_HAND_C_BlueprintInitCosmetic_Params
	{
	public:
	...
	/**
	 * Function CC_BASE_HAND.CC_BASE_HAND_C.BlueprintCosmeticMeshLoaded
	 */
	struct UCC_BASE_HAND_C_BlueprintCosmeticMeshLoaded_Params
	{
	public:
