...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Tagline_BigGameHunter.Tagline_BigGameHunter_C.BlueprintOnCheckRoundEndAward
	 */
	struct UTagline_BigGameHunter_C_BlueprintOnCheckRoundEndAward_Params
	{
	public:
