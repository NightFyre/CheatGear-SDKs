...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Lesson_46_Mines.Lesson_46_Mines_C.OnEquip
	 */
	struct ULesson_46_Mines_C_OnEquip_Params
	{
	public:
	...
	/**
	 * Function Lesson_46_Mines.Lesson_46_Mines_C.BlueprintOnInitialized
	 */
	struct ULesson_46_Mines_C_BlueprintOnInitialized_Params
	{
	public:
	...
	/**
	 * DelegateFunction Lesson_46_Mines.Lesson_46_Mines_C.OnWeaponEventDelegate__DelegateSignature
	 */
	struct ULesson_46_Mines_C_OnWeaponEventDelegate__DelegateSignature_Params
	{
	public:
		class AINSSoldier*                                         bpp__Interactor__pf;                                     // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class AItemWeapon*                                         bpp__Weapon__pf;                                         // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
