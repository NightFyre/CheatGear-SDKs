...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_MN9R[0x1E];                                  // 0x0028(0x001E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UZYF[0x9];                                   // 0x0047(0x0009) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O08G[0x10];                                  // 0x0138(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AW7K[0xA0];                                  // 0x01E8(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FControlRigDrawContainer                            DrawContainer;                                           // 0x0288(0x0018) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_0HFL[0x18];                                  // 0x02A0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SJYO[0xA8];                                  // 0x02D0(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2I4U[0x90];                                  // 0x03F8(0x0090) Fix size for supers
	...
	{
	public:
		unsigned char                                              UnknownData_HEJD[0x8];                                   // 0x0488(0x0008) Fix Super Size
		unsigned char                                              UnknownData_GA61[0x10];                                  // 0x0490(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_183L[0x8];                                   // 0x0348(0x0008) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_E9TP[0x3];                                   // 0x05B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2JHT[0x2];                                   // 0x05CE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NM2S[0xA8];                                  // 0x05D8(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LVQA[0x6];                                   // 0x028A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F7K9[0x7];                                   // 0x02A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9TLN[0x8];                                   // 0x0308(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              bEnabled : 1;                                            // 0x029C(0x0001) BIT_FIELD BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              bSelected : 1;                                           // 0x029C(0x0001) BIT_FIELD BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              bSelectable : 1;                                         // 0x029C(0x0001) BIT_FIELD BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              bHovered : 1;                                            // 0x029C(0x0001) BIT_FIELD BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_WFQ4[0x3];                                   // 0x029D(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_50PV[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EXJC[0x10];                                  // 0x0110(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P7LK[0x8];                                   // 0x0348(0x0008) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_ME1T[0x1];                                   // 0x002B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5T35[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_14AM[0x6];                                   // 0x004A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8GNK[0x4];                                   // 0x021C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OXIQ[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FO7R[0x30];                                  // 0x0038(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3PDA[0x7];                                   // 0x0499(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3BDJ[0x18];                                  // 0x0148(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_66R9[0x4];                                   // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NAHF[0x58];                                  // 0x02F0(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K0LF[0x28];                                  // 0x0090(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_KA94[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BG0V[0x75];                                  // 0x005B(0x0075) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WRPI[0x5C];                                  // 0x00D4(0x005C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CVMC[0x50];                                  // 0x0138(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FRigElementKey, struct FRigElementKey>         PreviousNameMap;                                         // 0x0188(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_9AL8[0x20];                                  // 0x01D8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_K20T[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BSZR[0x6C];                                  // 0x0034(0x006C) MISSED OFFSET (PADDING)
