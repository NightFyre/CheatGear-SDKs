...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_19AA[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              bUpdateMassWhenScaleChanges : 1;                         // 0x0010(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_J0E2[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
