...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_2KI6[0x8];                                   // 0x0568(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_PV2H[0x6];                                   // 0x0572(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3Q4U[0x8];                                   // 0x05E8(0x0008) MISSED OFFSET (PADDING)
