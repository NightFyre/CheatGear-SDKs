...
namespace CG
{
	...
	public:
		...
		unsigned char                                              bSupportsHardwareAEC : 1;                                // 0x0028(0x0001) BIT_FIELD BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_ZFDD[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	};
