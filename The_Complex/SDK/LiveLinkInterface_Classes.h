...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_HL3Y[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8E7D[0x107];                                 // 0x0059(0x0107) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YHVR[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UClass*                                              Factory;                                                 // 0x00A0(0x0008) Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                              UnknownData_ASD2[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
