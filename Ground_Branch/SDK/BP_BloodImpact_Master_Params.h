...
namespace CG
{
	 ...
	 */
	struct ABP_BloodImpact_Master_C_SetPhysicCollisionInfo_Params
	{
	public:
	...
	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.ReceiveBeginPlay
	 */
	struct ABP_BloodImpact_Master_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.SetHitResult
	 */
	struct ABP_BloodImpact_Master_C_SetHitResult_Params
	{
	public:
	...
	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.SpawnImpactParticleFX
	 */
	struct ABP_BloodImpact_Master_C_SpawnImpactParticleFX_Params
	{	};

	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.SpawnImpactSound
	 */
	struct ABP_BloodImpact_Master_C_SpawnImpactSound_Params
	{	};

	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.SpawnDecal
	 */
	struct ABP_BloodImpact_Master_C_SpawnDecal_Params
	{	};

	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.K2_OnReset
	 */
	struct ABP_BloodImpact_Master_C_K2_OnReset_Params
	{	};

	/**
	 * Function BP_BloodImpact_Master.BP_BloodImpact_Master_C.ExecuteUbergraph_BP_BloodImpact_Master
	 */
	struct ABP_BloodImpact_Master_C_ExecuteUbergraph_BP_BloodImpact_Master_Params
	{
	public:
