...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Gloves_Master.BP_Gloves_Master_C.OnAddedToCharacter
	 */
	struct ABP_Gloves_Master_C_OnAddedToCharacter_Params
	{
	public:
	...
	/**
	 * Function BP_Gloves_Master.BP_Gloves_Master_C.OnRemovedFromCharacter
	 */
	struct ABP_Gloves_Master_C_OnRemovedFromCharacter_Params
	{
	public:
	...
	/**
	 * Function BP_Gloves_Master.BP_Gloves_Master_C.ExecuteUbergraph_BP_Gloves_Master
	 */
	struct ABP_Gloves_Master_C_ExecuteUbergraph_BP_Gloves_Master_Params
	{
	public:
