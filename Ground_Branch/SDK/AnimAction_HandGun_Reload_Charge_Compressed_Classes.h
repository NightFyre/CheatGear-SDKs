...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass AnimAction_HandGun_Reload_Charge_Compressed.AnimAction_HandGun_Reload_Charge_Compressed_C
	 * Size -> 0x001C (FullSize[0x0148] - InheritedSize[0x012C])
	 */
	class UAnimAction_HandGun_Reload_Charge_Compressed_C : public UAnimAction_Reload_Master_C
	{
	public:
		unsigned char                                              UnknownData_3G4U[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void TriggerAction();
		void ExecuteUbergraph_AnimAction_HandGun_Reload_Charge_Compressed(int32_t EntryPoint);
