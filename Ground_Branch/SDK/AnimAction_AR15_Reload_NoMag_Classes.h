...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass AnimAction_AR15_Reload_NoMag.AnimAction_AR15_Reload_NoMag_C
	 * Size -> 0x001C (FullSize[0x0148] - InheritedSize[0x012C])
	 */
	class UAnimAction_AR15_Reload_NoMag_C : public UAnimAction_Reload_Master_C
	{
	public:
		unsigned char                                              UnknownData_WVF2[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void TriggerAction();
		void ExecuteUbergraph_AnimAction_AR15_Reload_NoMag(int32_t EntryPoint);
