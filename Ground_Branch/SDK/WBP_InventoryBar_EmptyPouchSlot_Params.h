...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function WBP_InventoryBar_EmptyPouchSlot.WBP_InventoryBar_EmptyPouchSlot_C.GetVisibility_1
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_GetVisibility_1_Params
	{
	public:
	 ...
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_SetInventorySlotItem_Params
	{
	public:
	 ...
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_EquipInventorySlotItem_Params
	{
	public:
	 ...
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_BndEvt__CheckBox_Tab_K2Node_ComponentBoundEvent_1034_OnCheckBoxComponentStateChanged__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_InternalSetSelected_Params
	{
	public:
	 ...
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_Construct_Params
	{	};

	/**
	 * Function WBP_InventoryBar_EmptyPouchSlot.WBP_InventoryBar_EmptyPouchSlot_C.OnIconLoaded
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_OnIconLoaded_Params
	{
	public:
	 ...
	 */
	struct UWBP_InventoryBar_EmptyPouchSlot_C_ExecuteUbergraph_WBP_InventoryBar_EmptyPouchSlot_Params
	{
	public:
