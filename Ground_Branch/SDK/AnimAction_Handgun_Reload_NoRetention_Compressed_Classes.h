...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass AnimAction_Handgun_Reload_NoRetention_Compressed.AnimAction_Handgun_Reload_NoRetention_Compressed_C
	 * Size -> 0x001C (FullSize[0x0148] - InheritedSize[0x012C])
	 */
	class UAnimAction_Handgun_Reload_NoRetention_Compressed_C : public UAnimAction_Reload_Master_C
	{
	public:
		unsigned char                                              UnknownData_JRQE[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void TriggerAction();
		void ExecuteUbergraph_AnimAction_Handgun_Reload_NoRetention_Compressed(int32_t EntryPoint);
