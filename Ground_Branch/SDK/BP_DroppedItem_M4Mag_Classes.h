...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_DroppedItem_M4Mag.BP_DroppedItem_M4Mag_C
	 * Size -> 0x0018 (FullSize[0x02A8] - InheritedSize[0x0290])
	 */
	class ABP_DroppedItem_M4Mag_C : public AGBDroppedItem
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_DroppedItem_M4Mag(int32_t EntryPoint);
