...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_DroppedItem_Rifle.BP_DroppedItem_Rifle_C
	 * Size -> 0x0020 (FullSize[0x02B0] - InheritedSize[0x0290])
	 */
	class ABP_DroppedItem_Rifle_C : public AGBDroppedItem
	{
	public:
	...
	public:
		...
		void PickupFirearm();
		void ExecuteUbergraph_BP_DroppedItem_Rifle(int32_t EntryPoint);
