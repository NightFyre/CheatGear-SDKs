...
namespace CG
{
	 ...
	 */
	class UWBP_BulletWarn_Overlay_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void HitUp();
		void HitForward();
		void OnPlayerControllerBulletWarn_Event_1(const struct FVector& ViewLocation, const struct FRotator& ViewRotation, const struct FVector& BulletLocation, bool bCanCrack);
		void ExecuteUbergraph_WBP_BulletWarn_Overlay(int32_t EntryPoint);
