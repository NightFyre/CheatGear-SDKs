...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Counterweight.BP_Counterweight_C.DecodeKit
	 */
	struct ABP_Counterweight_C_DecodeKit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_6IRL[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
