...
namespace CG
{
	 ...
	 */
	struct UOceanology_PluginBPLibrary_Oceanology_PluginSampleFunction_Params
	{
	public:
	 ...
	 */
	struct AQuadTree_SetEditorTickEnabled_Params
	{
	public:
	 ...
	 */
	struct AQuadTree_Procedural_Params
	{
	public:
		...
		int32_t                                                    GridTiles;                                               // 0x000C(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	struct AQuadTree_EditorTick_Params
	{
	public:
