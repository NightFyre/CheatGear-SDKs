...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_V2ZM[0x20];                                  // 0x0ED0(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EHID[0xF];                                   // 0x0EF1(0x000F) MISSED OFFSET (PADDING)
