...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9OYD[0x8];                                   // 0x02C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LFS8[0xE];                                   // 0x0332(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
