...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_WalkToCover.A_WalkToCover_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_WalkToCover_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_6H13[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GroupCheck();
		void ExecuteUbergraph_A_WalkToCover(int32_t EntryPoint);
