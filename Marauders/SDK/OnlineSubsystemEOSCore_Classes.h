...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DCXQ[0xA0];                                  // 0x0050(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4OGA[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_PHT0[0x98];                                  // 0x0040(0x0098) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EFJO[0x8];                                   // 0x1B90(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H5Z7[0x6];                                   // 0x07BA(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0030(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GTOC[0x88];                                  // 0x0040(0x0088) MISSED OFFSET (PADDING)
