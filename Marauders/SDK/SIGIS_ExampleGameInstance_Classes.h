...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5RVF[0x7];                                   // 0x1A39(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_T2L9[0x7];                                   // 0x1AB1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
