...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_UVV5[0x4];                                   // 0x094C(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_TRL7[0x7];                                   // 0x0969(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
