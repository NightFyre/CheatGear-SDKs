...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass AnimBP_M1Para.AnimBP_M1Para_C
	 * Size -> 0x034E (FullSize[0x0606] - InheritedSize[0x02B8])
	 */
	class UAnimBP_M1Para_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_07ND[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_AnimBP_M1Para(int32_t EntryPoint);
