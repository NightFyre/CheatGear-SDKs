...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_RunToOpen.A_RunToOpen_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_RunToOpen_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_2MUL[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GroupCheck();
		void ExecuteUbergraph_A_RunToOpen(int32_t EntryPoint);
