...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass ShipInside_DamageExplosion.ShipInside_DamageExplosion_C
	 * Size -> 0x0018 (FullSize[0x0250] - InheritedSize[0x0238])
	 */
	class AShipInside_DamageExplosion_C : public ABase_ShipInsideActor_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_ShipInside_DamageExplosion(int32_t EntryPoint);
