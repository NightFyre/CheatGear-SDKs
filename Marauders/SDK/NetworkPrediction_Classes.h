...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_S9V1[0x8];                                   // 0x0290(0x0008) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_JZ99[0x8];                                   // 0x0158(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8CDJ[0x608];                                 // 0x0038(0x0608) MISSED OFFSET (PADDING)
