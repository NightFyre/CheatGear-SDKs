...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_CrouchListener.A_CrouchListener_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_CrouchListener_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_J66U[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void StartAction();
		void FinishedTimer();
		void ExecuteUbergraph_A_CrouchListener(int32_t EntryPoint);
