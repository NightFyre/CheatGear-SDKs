...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_C2N6[0x8];                                   // 0x0468(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_PMY5[0x6];                                   // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZCXL[0x4];                                   // 0x04BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
