...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_ThinkPatrol.A_ThinkPatrol_C
	 * Size -> 0x0013 (FullSize[0x01BC] - InheritedSize[0x01A9])
	 */
	class UA_ThinkPatrol_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_JJ9N[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_A_ThinkPatrol(int32_t EntryPoint);
