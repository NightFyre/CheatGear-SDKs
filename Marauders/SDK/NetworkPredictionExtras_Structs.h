...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4IS3[0x2];                                   // 0x000E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_3PJV[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_VRQ3[0x3C];                                  // 0x0014(0x003C) MISSED OFFSET (PADDING)
	};
