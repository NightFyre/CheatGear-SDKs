...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function InsideShipPart_ShipHull_Widget.InsideShipPart_ShipHull_Widget_C.SetupInitialLook
	 */
	struct UInsideShipPart_ShipHull_Widget_C_SetupInitialLook_Params
	{
	public:
	...
	/**
	 * Function InsideShipPart_ShipHull_Widget.InsideShipPart_ShipHull_Widget_C.UpdatePartHealth
	 */
	struct UInsideShipPart_ShipHull_Widget_C_UpdatePartHealth_Params
	{
	public:
