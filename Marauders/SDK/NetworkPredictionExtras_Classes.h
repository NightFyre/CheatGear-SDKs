...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_SQA0[0x8];                                   // 0x02A8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TQ80[0x20];                                  // 0x02B0(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M6BH[0x10];                                  // 0x02D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E87D[0x20];                                  // 0x0340(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FS8D[0x8];                                   // 0x0298(0x0008) Fix Super Size
		unsigned char                                              UnknownData_G08M[0x10];                                  // 0x02A0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_R0DC[0x10];                                  // 0x02B0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F5UN[0x1F];                                  // 0x0301(0x001F) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LUHM[0xB0];                                  // 0x02B0(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_F6TA[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              SourceList[0x10];                                        // 0x0030(0x0010) UNKNOWN PROPERTY: ArrayProperty
		unsigned char                                              UnknownData_ESLZ[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RPCU[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VTOH[0x6];                                   // 0x0282(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZVBY[0x18];                                  // 0x0290(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RUBJ[0x7];                                   // 0x02A9(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_D4SI[0x8];                                   // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BXL4[0x7];                                   // 0x02B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7FC8[0x1];                                   // 0x0313(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GT9J[0x8];                                   // 0x0318(0x0008) MISSED OFFSET (PADDING)
