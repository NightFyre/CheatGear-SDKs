...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_MoveToLoot.A_MoveToLoot_C
	 * Size -> 0x0027 (FullSize[0x01D0] - InheritedSize[0x01A9])
	 */
	class UA_MoveToLoot_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_TUN7[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void CheckIfClose();
		void LookWiggle();
		void ExecuteUbergraph_A_MoveToLoot(int32_t EntryPoint);
