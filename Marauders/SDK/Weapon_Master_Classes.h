...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_MWYI[0x8];                                   // 0x08C8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_WHQO[0x3];                                   // 0x08F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
