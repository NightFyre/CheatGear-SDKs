...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_RunToCover.A_RunToCover_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_RunToCover_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_1BJ3[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GroupCheck();
		void CheckIfCloseToPlayer();
		void ExecuteUbergraph_A_RunToCover(int32_t EntryPoint);
