...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_CrouchToLoot.A_CrouchToLoot_C
	 * Size -> 0x0027 (FullSize[0x01D0] - InheritedSize[0x01A9])
	 */
	class UA_CrouchToLoot_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_CVW3[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void CheckIfClose();
		void LookWiggle();
		void ExecuteUbergraph_A_CrouchToLoot(int32_t EntryPoint);
