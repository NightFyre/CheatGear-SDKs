...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_ChargeStalker.A_ChargeStalker_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_ChargeStalker_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_Q6TU[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void FinishedTimer();
		void ExecuteUbergraph_A_ChargeStalker(int32_t EntryPoint);
