...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_SuprisedReload.A_SuprisedReload_C
	 * Size -> 0x0017 (FullSize[0x01C0] - InheritedSize[0x01A9])
	 */
	class UA_SuprisedReload_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_NRWP[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void LookWiggle();
		void ExecuteUbergraph_A_SuprisedReload(int32_t EntryPoint);
