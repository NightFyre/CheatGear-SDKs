...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_AdvancedFire.A_AdvancedFire_C
	 * Size -> 0x0017 (FullSize[0x01C0] - InheritedSize[0x01A9])
	 */
	class UA_AdvancedFire_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_L0XQ[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ShootAtPlayer();
		void FinishedTimer();
		void ExecuteUbergraph_A_AdvancedFire(int32_t EntryPoint);
