...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_BackPedal.A_BackPedal_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_BackPedal_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_KPHS[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_A_BackPedal(int32_t EntryPoint);
