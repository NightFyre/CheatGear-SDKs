...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass A_Dodge.A_Dodge_C
	 * Size -> 0x000F (FullSize[0x01B8] - InheritedSize[0x01A9])
	 */
	class UA_Dodge_C : public U00_ActionParent_C
	{
	public:
		unsigned char                                              UnknownData_UVPH[0x7];                                   // 0x01A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ShuffleAround();
		void ExecuteUbergraph_A_Dodge(int32_t EntryPoint);
