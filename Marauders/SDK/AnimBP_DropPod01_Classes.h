...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_PY50[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_SMWL[0x1];                                   // 0x0FB7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UMOT[0x3];                                   // 0x1015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B8H0[0x3];                                   // 0x1031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
