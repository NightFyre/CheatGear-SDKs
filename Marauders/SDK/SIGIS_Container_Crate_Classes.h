...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SIGIS_Container_Crate.SIGIS_Container_Crate_C
	 * Size -> 0x0014 (FullSize[0x04D8] - InheritedSize[0x04C4])
	 */
	class ASIGIS_Container_Crate_C : public ASIGIS_BaseLootableContainer_C
	{
	public:
		unsigned char                                              UnknownData_LHSF[0x4];                                   // 0x04C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
