...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Door_UPDown04.Door_UPDown04_C
	 * Size -> 0x003E (FullSize[0x04F6] - InheritedSize[0x04B8])
	 */
	class ADoor_UPDown04_C : public ABase_Door_C
	{
	public:
		...
		float                                                      Timeline_0_DoorMovePercent_64E2AB9847D12E654EDE37BBB006B44F; // 0x04D8(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		ETimelineDirection                                         Timeline_0__Direction_64E2AB9847D12E654EDE37BBB006B44F;  // 0x04DC(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		unsigned char                                              UnknownData_OVHS[0x3];                                   // 0x04DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ActiveCalled();
		void ExecuteUbergraph_Door_UPDown04(int32_t EntryPoint);
