...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LFK4[0x6];                                   // 0x0432(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GI0U[0x2];                                   // 0x0486(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6HNG[0x18];                                  // 0x04A8(0x0018) MISSED OFFSET (PADDING)
