...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XOAJ[0x4];                                   // 0x0204(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KIG3[0x4];                                   // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7880[0x18];                                  // 0x0248(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3BVD[0x8];                                   // 0x0408(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_E1IZ[0x5];                                   // 0x041B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B8W3[0x40];                                  // 0x0440(0x0040) MISSED OFFSET (PADDING)
