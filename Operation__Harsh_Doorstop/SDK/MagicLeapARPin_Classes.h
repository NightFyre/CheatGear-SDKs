...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UBNE[0x2];                                   // 0x0206(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R0SJ[0xD0];                                  // 0x0250(0x00D0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_A88O[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7X0V[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
