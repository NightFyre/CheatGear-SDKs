...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WB_TabMyStorage.WB_TabMyStorage_C
	 * Size -> 0x0020 (FullSize[0x0338] - InheritedSize[0x0318])
	 */
	class UWB_TabMyStorage_C : public UInventoryTabWidgetBase
	{
	public:
	...
	public:
		...
		void BndEvt__WB_TabMyStorage_Btn_InventoryTab_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature();
		void BndEvt__WB_TabMyStorage_Btn_InventoryTab_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature();
		void ExecuteUbergraph_WB_TabMyStorage(int32_t EntryPoint);
