...
namespace CG
{
	 ...
	 */
	struct UABP_PlayerCharacterResurrection_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UABP_PlayerCharacterResurrection_C_ExecuteUbergraph_ABP_PlayerCharacterResurrection_Params
	{
	public:
