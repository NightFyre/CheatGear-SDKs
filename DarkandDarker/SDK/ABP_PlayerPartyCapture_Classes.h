...
namespace CG
{
	 ...
	 */
	class UABP_PlayerPartyCapture_C : public UDCPlayerCharacterAnimInstanceBase
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0520(0x0008) ZeroConstructor, Transient, DuplicateTransient
		struct UABP_PlayerPartyCapture_C_FAnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                                 // 0x0528(0x0058) HasGetValueTypeHash
	...
	public:
		...
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_AnimGraphNode_TransitionResult_02F566904DB6622313DD60ADE589A1EB();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_AnimGraphNode_TransitionResult_2D3A5A7F4D5DC517C82E59B5CAB14DD2();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_AnimGraphNode_TransitionResult_7F151C77406CFCE66438FD97FA547FB0();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_AnimGraphNode_TransitionResult_1C8B595B420250701EAF35B5224CA995();
		...
		void ExecuteUbergraph_ABP_PlayerPartyCapture(int32_t EntryPoint);
