...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7QFO[0x48];                                  // 0x0078(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ID2P[0x6];                                   // 0x004A(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PE3T[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_KKRZ[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HS0P[0x28];                                  // 0x00E0(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_I9QD[0x28];                                  // 0x0078(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9V2D[0x28];                                  // 0x0078(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KLXR[0x98];                                  // 0x0030(0x0098) MISSED OFFSET (PADDING)

	public:
		bool STATIC_NotEqual_DataRegistryType(const struct FDataRegistryType& A, const struct FDataRegistryType& B);
		bool STATIC_NotEqual_DataRegistryId(const struct FDataRegistryId& A, const struct FDataRegistryId& B);
		bool STATIC_IsValidDataRegistryType(const struct FDataRegistryType& DataRegistryType);
		bool STATIC_IsValidDataRegistryId(const struct FDataRegistryId& DataRegistryId);
		bool STATIC_GetCachedItemFromLookupBP(const struct FDataRegistryId& ItemId, const struct FDataRegistryLookup& ResolvedLookup, struct FTableRowBase* OutItem);
		bool STATIC_GetCachedItemBP(const struct FDataRegistryId& ItemId, struct FTableRowBase* OutItem);
		void STATIC_FindCachedItemBP(const struct FDataRegistryId& ItemId, EDataRegistrySubsystemGetItemResult* OutResult, struct FTableRowBase* OutItem);
		void STATIC_EvaluateDataRegistryCurve(const struct FDataRegistryId& ItemId, float InputValue, float DefaultValue, EDataRegistrySubsystemGetItemResult* OutResult, float* OutValue);
		bool STATIC_EqualEqual_DataRegistryType(const struct FDataRegistryType& A, const struct FDataRegistryType& B);
		bool STATIC_EqualEqual_DataRegistryId(const struct FDataRegistryId& A, const struct FDataRegistryId& B);
		class FString STATIC_Conv_DataRegistryTypeToString(const struct FDataRegistryType& DataRegistryType);
		class FString STATIC_Conv_DataRegistryIdToString(const struct FDataRegistryId& DataRegistryId);
		bool STATIC_AcquireItemBP(const struct FDataRegistryId& ItemId, const class FScriptDelegate& AcquireCallback);
		static UClass* StaticClass();
	};
