...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_CUYY[0x8];                                   // 0x0B20(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S0K4[0x2C];                                  // 0x0B34(0x002C) MISSED OFFSET (PADDING)
