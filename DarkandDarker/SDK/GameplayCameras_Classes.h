...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_D562[0x6];                                   // 0x005A(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MEP2[0x4];                                   // 0x00EC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_FW5A[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5287[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PG72[0x4];                                   // 0x00EC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_T0P2[0x4];                                   // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       bRandomAnimSegment : 1;                                  // 0x0170(0x0001) BIT_FIELD Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_6RLI[0x3];                                   // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_06VR[0x78];                                  // 0x0180(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TAHI[0x30];                                  // 0x0200(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_66KU[0x38];                                  // 0x0080(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F84I[0x3C];                                  // 0x009C(0x003C) MISSED OFFSET (PADDING)
