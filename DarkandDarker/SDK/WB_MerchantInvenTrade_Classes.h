...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WB_MerchantInvenTrade.WB_MerchantInvenTrade_C
	 * Size -> 0x0020 (FullSize[0x0420] - InheritedSize[0x0400])
	 */
	class UWB_MerchantInvenTrade_C : public UWB_MerchantInventoryWidgetBase_C
	{
	public:
	...
	public:
		...
		void Construct();
		void OnInitialized();
		void ExecuteUbergraph_WB_MerchantInvenTrade(int32_t EntryPoint);
