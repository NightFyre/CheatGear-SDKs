...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IE2U[0x20];                                  // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UNHM[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_8Y1G[0x40];                                  // 0x0070(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RALP[0x30];                                  // 0x02C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EYA9[0x7];                                   // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1C11[0x18];                                  // 0x0318(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZCBJ[0xF];                                   // 0x0331(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_D8HX[0x5];                                   // 0x0333(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U39U[0x28];                                  // 0x0398(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_WLZ3[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_XQ7G[0x38];                                  // 0x0070(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W1HB[0x10];                                  // 0x02D0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AAX9[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9FG0[0x1F];                                  // 0x0101(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CRS7[0x10];                                  // 0x0140(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_R1PA[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DDY3[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_92TB[0x1];                                   // 0x008F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WBU1[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NI1S[0x6];                                   // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1RAE[0x64];                                  // 0x0364(0x0064) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9EUM[0x8];                                   // 0x0318(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VZ2M[0x8];                                   // 0x07C8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IOHI[0x8];                                   // 0x0290(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3VM8[0x3];                                   // 0x01F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QEDG[0x8];                                   // 0x0218(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_G283[0x3];                                   // 0x0291(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HZF5[0x8];                                   // 0x02B8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZUBU[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2WMQ[0xF];                                   // 0x0101(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KSYF[0x16];                                  // 0x011A(0x0016) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6KXZ[0xC];                                   // 0x0134(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1YRQ[0x10];                                  // 0x0148(0x0010) Fix size for supers
	...
	{
	public:
		unsigned char                                              UnknownData_9LVD[0x8];                                   // 0x0158(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_XMZY[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7403[0x8];                                   // 0x0158(0x0008) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_L6SQ[0xC];                                   // 0x0184(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XF3S[0x7];                                   // 0x0171(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<EARFaceBlendShape, float>                             BlendShapes;                                             // 0x0178(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_X9K0[0x38];                                  // 0x01C8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_YVPQ[0x8];                                   // 0x0178(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MZ2O[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LMDI[0x8];                                   // 0x0158(0x0008) Fix Super Size
	...
	{
	public:
		unsigned char                                              UnknownData_MPX4[0x8];                                   // 0x0158(0x0008) Fix Super Size
		unsigned char                                              UnknownData_NDI1[0x10];                                  // 0x0160(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1WBU[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
