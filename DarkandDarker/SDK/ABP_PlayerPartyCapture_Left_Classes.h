...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_PlayerPartyCapture_Left.ABP_PlayerPartyCapture_Left_C
	 * Size -> 0x0E3B (FullSize[0x135B] - InheritedSize[0x0520])
	 */
	class UABP_PlayerPartyCapture_Left_C : public UDCPlayerCharacterAnimInstanceBase
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0520(0x0008) ZeroConstructor, Transient, DuplicateTransient
		struct UABP_PlayerPartyCapture_Left_C_FAnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                                 // 0x0528(0x0058) HasGetValueTypeHash
	...
	public:
		...
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_Left_AnimGraphNode_TransitionResult_03C2D9AF4C1DC963BFB08E9CEF1CA8BC();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_Left_AnimGraphNode_TransitionResult_9AAF87644B5DF305EFE5F4A36F57A835();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_Left_AnimGraphNode_TransitionResult_953E63FA4318535E61A38DA55936A9FF();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlayerPartyCapture_Left_AnimGraphNode_TransitionResult_47F40C8B431B932EDA7D8F9A95FF7BAE();
		...
		void ExecuteUbergraph_ABP_PlayerPartyCapture_Left(int32_t EntryPoint);
