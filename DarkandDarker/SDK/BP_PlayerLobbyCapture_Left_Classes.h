...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_PlayerLobbyCapture_Left.BP_PlayerLobbyCapture_Left_C
	 * Size -> 0x0020 (FullSize[0x0800] - InheritedSize[0x07E0])
	 */
	class ABP_PlayerLobbyCapture_Left_C : public ADCCharacterLobbyCapture
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_PlayerLobbyCapture_Left(int32_t EntryPoint);
