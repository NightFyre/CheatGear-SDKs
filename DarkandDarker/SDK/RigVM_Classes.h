...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ERWQ[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMByteCode                                      ByteCodeStorage;                                         // 0x0060(0x0030) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_H59F[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMInstructionArray                              Instructions;                                            // 0x0098(0x0010) Transient, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_TH7Y[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IH1E[0x4];                                   // 0x0174(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FName>                                        FunctionNamesStorage;                                    // 0x0178(0x0010) ZeroConstructor, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_SCVB[0x20];                                  // 0x0188(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2TY9[0x98];                                  // 0x0208(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_04DK[0x18];                                  // 0x02A8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WB7U[0x38];                                  // 0x0230(0x0038) MISSED OFFSET (PADDING)
