...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_U355[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_39CY[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_QFOL[0x6];                                   // 0x005A(0x0006) MISSED OFFSET (PADDING)
	};
