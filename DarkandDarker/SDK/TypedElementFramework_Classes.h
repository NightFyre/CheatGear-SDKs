...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_GGKK[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8VBR[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Z12T[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ETVR[0x920];                                 // 0x0028(0x0920) MISSED OFFSET (PADDING)
