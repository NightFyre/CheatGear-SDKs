...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WB_PerkSlotInventory.WB_PerkSlotInventory_C
	 * Size -> 0x0068 (FullSize[0x0358] - InheritedSize[0x02F0])
	 */
	class UWB_PerkSlotInventory_C : public UDCWidgetBase
	{
	public:
		...
		class UWB_Perk_C*                                          WB_Perk;                                                 // 0x0330(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class UWB_PerkEquipable_C*                                 WB_PerkEquipable;                                        // 0x0338(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_P1K2[0x3];                                   // 0x0345(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UWB_ClassCurrentPerk_C*                              WB_ClassCurrentPerk;                                     // 0x0350(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void BndEvt__WB_PerkSlotInventory_Btn_Perk_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature();
		void OnPress();
		void OnRelease();
		void OnClick();
		void ExecuteUbergraph_WB_PerkSlotInventory(int32_t EntryPoint);
