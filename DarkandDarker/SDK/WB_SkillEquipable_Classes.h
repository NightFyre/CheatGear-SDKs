...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WB_SkillEquipable.WB_SkillEquipable_C
	 * Size -> 0x0018 (FullSize[0x0308] - InheritedSize[0x02F0])
	 */
	class UWB_SkillEquipable_C : public UDCWidgetBase
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_WB_SkillEquipable(int32_t EntryPoint);
