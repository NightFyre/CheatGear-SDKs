...
namespace CG
{
	 ...
	 */
	class UWB_CommonBtn_S_C : public UCommonButtonSWidget
	{
	public:
		...
		unsigned char                                              UnknownData_LCSJ[0x8];                                   // 0x0358(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_WB_CommonBtn_S(int32_t EntryPoint);
