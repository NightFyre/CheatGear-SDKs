...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WB_LeaderBoardCategoryInfoBtn.WB_LeaderBoardCategoryInfoBtn_C
	 * Size -> 0x0028 (FullSize[0x02B8] - InheritedSize[0x0290])
	 */
	class UWB_LeaderBoardCategoryInfoBtn_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_WB_LeaderBoardCategoryInfoBtn(int32_t EntryPoint);
