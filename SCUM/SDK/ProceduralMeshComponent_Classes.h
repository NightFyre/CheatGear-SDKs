...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_TZAI[0x8];                                   // 0x0478(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_COHP[0x6];                                   // 0x0482(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EQEG[0x4];                                   // 0x04CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
