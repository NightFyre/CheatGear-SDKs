...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_SVD_Magazine.ABP_SVD_Magazine_C
	 * Size -> 0x0C68 (FullSize[0x0F48] - InheritedSize[0x02E0])
	 */
	class UABP_SVD_Magazine_C : public UWeaponAttachmentMagazineAnimInstance
	{
	public:
		...
		struct FAnimNode_BlendListByInt                            AnimGraphNode_BlendListByInt;                            // 0x0A58(0x00A0)
	...
	public:
		...
		void ExecuteUbergraph_ABP_SVD_Magazine(int32_t EntryPoint);
