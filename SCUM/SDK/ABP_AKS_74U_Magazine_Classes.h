...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_AKS_74U_Magazine.ABP_AKS_74U_Magazine_C
	 * Size -> 0x0C68 (FullSize[0x0F48] - InheritedSize[0x02E0])
	 */
	class UABP_AKS_74U_Magazine_C : public UWeaponAttachmentMagazineAnimInstance
	{
	public:
		...
		struct FAnimNode_BlendListByInt                            AnimGraphNode_BlendListByInt;                            // 0x0958(0x00A0)
		struct FAnimNode_SequencePlayer                            AnimGraphNode_SequencePlayer_8;                          // 0x09F8(0x0080)
		struct FAnimNode_SequencePlayer                            AnimGraphNode_SequencePlayer_7;                          // 0x0A78(0x0080)
		struct FAnimNode_BlendListByEnum                           AnimGraphNode_BlendListByEnum;                           // 0x0AF8(0x00B0)
	...
	public:
		...
		void ExecuteUbergraph_ABP_AKS_74U_Magazine(int32_t EntryPoint);
