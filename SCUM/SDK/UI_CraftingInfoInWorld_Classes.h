...
namespace CG
{
	...
	public:
		...
		class UImage*                                              CraftingTitle;                                           // 0x0378(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UTextBlock*                                          TitleText;                                               // 0x0398(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void Init(class AItem* itemCDO);
		void SetCaptionAndDescription(const class FText& Caption, const class FText& Description);
		void ExecuteUbergraph_UI_CraftingInfoInWorld(int32_t EntryPoint);
