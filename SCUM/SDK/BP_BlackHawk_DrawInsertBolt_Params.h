...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_BlackHawk_DrawInsertBolt.BP_BlackHawk_DrawInsertBolt_C.CanExecuteUsingData
	 */
	struct UBP_BlackHawk_DrawInsertBolt_C_CanExecuteUsingData_Params
	{
	public:
