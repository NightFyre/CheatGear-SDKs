...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_9NLS[0x4];                                   // 0x00AC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_I5B8[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IEST[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_03MR[0x4];                                   // 0x00AC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_VNWB[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SKU2[0x3];                                   // 0x0131(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BJG7[0x40];                                  // 0x0140(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KSWZ[0x28];                                  // 0x0188(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1V0K[0x38];                                  // 0x0080(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_DCRK[0x3C];                                  // 0x009C(0x003C) MISSED OFFSET (PADDING)
