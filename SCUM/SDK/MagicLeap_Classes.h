...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NK9S[0x8];                                   // 0x0120(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_34ZX[0x50];                                  // 0x0180(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ABCJ[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_ZK7D[0x6];                                   // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3VQI[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B8RL[0x3];                                   // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QURB[0x5];                                   // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_63NT[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YDLD[0x14];                                  // 0x027C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JBEF[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TR64[0x68];                                  // 0x00B0(0x0068) MISSED OFFSET (PADDING)
