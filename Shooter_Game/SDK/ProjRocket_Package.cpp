...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ProjRocket.ProjRocket_C.OnTakeAnyDamage_Event
	 * 		Flags  -> ()
	 * Parameters:
	 ...
	 */
	void AProjRocket_C::OnTakeAnyDamage_Event(class AActor* DamagedActor, float Damage, class UDamageType* DamageType, class AController* InstigatedBy, class AActor* DamageCauser)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ProjRocket.ProjRocket_C.OnTakeAnyDamage_Event");
		
		AProjRocket_C_OnTakeAnyDamage_Event_Params params {};
