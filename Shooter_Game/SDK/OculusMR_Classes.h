...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0DJF[0x50];                                  // 0x0288(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_BXK8[0x8];                                   // 0x0468(0x0008) Fix Super Size
		unsigned char                                              UnknownData_AS13[0x10];                                  // 0x0470(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZOKL[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CTLT[0x44];                                  // 0x0054(0x0044) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8QGL[0x4];                                   // 0x00B0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LG4F[0x2];                                   // 0x00B6(0x0002) MISSED OFFSET (PADDING)
