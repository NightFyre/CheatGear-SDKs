...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YXQS[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M5P5[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RDL1[0x1];                                   // 0x005F(0x0001) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LGVK[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P2ZR[0x48];                                  // 0x0048(0x0048) MISSED OFFSET (PADDING)
