...
namespace CG
{
	 ...
	 * Size -> 0x0700 (FullSize[0x0780] - InheritedSize[0x0080])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_MLPM[0x6];                                   // 0x04CA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0NJ8[0x4];                                   // 0x057C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
