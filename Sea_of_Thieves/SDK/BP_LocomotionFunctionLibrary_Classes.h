...
namespace CG
{
	...
	public:
		...
		void STATIC_ArrayLoadingFromDataDriven1DBlendSpace(TArray<class UBlendSpace1D*>* TargetArray_D, TArray<class UBlendSpace1D*>* LoadedArrayData_D, class UBlendSpace1D* FallbackBlendspace1D, class UObject* __WorldContext);
		...
		void STATIC_Update_IK_Limb_Controls(class USkeletalMeshComponent* SkeletalMeshComponent, EIKLimbName Limb_ID, bool Active, ELimbIKSpace Coordinate_Space, float Translation_Strength, float Rotation_Strength, const struct FTransform& Transform, float BlendIn, float BlendOut, class UObject* __WorldContext);
		void STATIC_Decrement_Integer(int32_t* Value, int32_t Decrement, class UObject* __WorldContext);
		void STATIC_Increment_Integer(int32_t* integer, int32_t Increment, class UObject* __WorldContext);
		...
		void STATIC_JumpingLogic(class ACharacter* PlayerCharacter, float MovementSpeed, float FrameDelta, float* JumpImpactTimerMax, EJumping* JumpingState, float* PreImpactTime, float* JumpImpactTimer, class UObject* __WorldContext);
		void STATIC_Ik_Blending(float* BlendCounter, bool IKON, float* Translation_Strength, float* Rotation_Strength, EEasingFunc EaseingType, float BlendMax, float FrameDeltaTime, class UObject* __WorldContext);
		...
		void STATIC_Out_Over_Time(float CurrentTime, float MaxTime, EEasingFunc EasingType, class UObject* __WorldContext, float* Return_Val);
