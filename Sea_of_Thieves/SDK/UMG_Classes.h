...
namespace CG
{
	...
	{
	public:
		class FString                                              Tag;                                                     // 0x0028(0x0010) Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash
		...
		EDragPivot                                                 Pivot;                                                   // 0x0048(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
		unsigned char                                              UnknownData_ZH0R[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BLIP[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnDrop;                                                  // 0x0058(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnDragCancelled;                                         // 0x0068(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnDragged;                                               // 0x0078(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
	 ...
	 * Size -> 0x0350 (FullSize[0x03E8] - InheritedSize[0x0098])
	 */
	class UMovieScene2DTransformSection : public UMovieSceneSection
	{
	public:
		unsigned char                                              UnknownData_RU66[0x8];                                   // 0x0098(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_F70O[0x8];                                   // 0x0098(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		TArray<class FName>                                        BrushPropertyNamePath;                                   // 0x0098(0x0010) ZeroConstructor
		class FName                                                TrackName;                                               // 0x00A8(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		class FName                                                DestinationProperty;                                     // 0x0040(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	{
	public:
		unsigned char                                              UnknownData_X66K[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P9E1[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_X3PI[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ALP4[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RTK9[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    RevealedIndex;                                           // 0x002C(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		unsigned char                                              UnknownData_MY89[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DSZU[0x3];                                   // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      bIsEnabledDelegate;                                      // 0x003C(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_A1A4[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                ToolTipText;                                             // 0x0050(0x0018) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, BlueprintReadOnly
		unsigned char                                              UnknownData_Y3E1[0x20];                                  // 0x0068(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		class FScriptDelegate                                      ToolTipWidgetDelegate;                                   // 0x00A0(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		ESlateVisibility                                           Visiblity;                                               // 0x00B0(0x0001) ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ESlateVisibility                                           Visibility;                                              // 0x00B1(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_2ZD0[0x2];                                   // 0x00B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      VisibilityDelegate;                                      // 0x00B4(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              bOverride_Cursor : 1;                                    // 0x00C4(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              UnknownData_BH9N[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EMouseCursor                                               Cursor;                                                  // 0x00C8(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_9IRG[0x2];                                   // 0x00CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JEJH[0x30];                                  // 0x00F8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_HOG2[0x8];                                   // 0x0138(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptDelegate                                      ColorAndOpacityDelegate;                                 // 0x0150(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		struct FSlateColor                                         ForegroundColor;                                         // 0x0160(0x0030) Edit, BlueprintVisible, BlueprintReadOnly
		class FScriptDelegate                                      ForegroundColorDelegate;                                 // 0x0190(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		bool                                                       bSupportsKeyboardFocus;                                  // 0x01A0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_VJCE[0x7];                                   // 0x01A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IPAL[0x50];                                  // 0x01E0(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		void PlayAnimation(class UWidgetAnimation* InAnimation, float StartAtTime, int32_t NumLoopsToPlay, EUMGSequencePlayMode PlayMode);
	 ...
	 * Size -> 0x05A0 (FullSize[0x05C8] - InheritedSize[0x0028])
	 */
	class UUMGSequencePlayer : public UObject
	{
	public:
		unsigned char                                              UnknownData_7TYR[0x368];                                 // 0x0028(0x0368) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UWidgetAnimation*                                    Animation;                                               // 0x0390(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_GFIK[0x230];                                 // 0x0398(0x0230) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		unsigned char                                              UnknownData_RYUC[0x1E];                                  // 0x004A(0x001E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_GQK7[0x1E];                                  // 0x004A(0x001E) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3AQ8[0x3];                                   // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    ZOrder;                                                  // 0x0064(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_UYCA[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0038(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0039(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_GFE0[0x2];                                   // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    Row;                                                     // 0x003C(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    RowSpan;                                                 // 0x0040(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    Column;                                                  // 0x0044(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    ColumnSpan;                                              // 0x0048(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    Layer;                                                   // 0x004C(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FVector2D                                           Nudge;                                                   // 0x0050(0x0008) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_4O6T[0x8];                                   // 0x0058(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0050(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0051(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_13TR[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_8132[0xE];                                   // 0x004A(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HAlign;                                                  // 0x0039(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VAlign;                                                  // 0x003A(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_SNY5[0x1];                                   // 0x003B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FMargin                                             Padding;                                                 // 0x003C(0x0010) Edit, BlueprintVisible, BlueprintReadOnly
		unsigned char                                              UnknownData_2DK3[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_FBQO[0x1E];                                  // 0x004A(0x001E) MISSED OFFSET (PADDING)
	...
	public:
		struct FMargin                                             Padding;                                                 // 0x0038(0x0010) Edit, BlueprintVisible, BlueprintReadOnly
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_1CDJ[0xF];                                   // 0x0049(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_55FU[0x1E];                                  // 0x004A(0x001E) MISSED OFFSET (PADDING)
	...
	public:
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0038(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0039(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_WR6D[0x2];                                   // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    Row;                                                     // 0x003C(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    Column;                                                  // 0x0040(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_KQI5[0xC];                                   // 0x0044(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0050(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0051(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_4LAY[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_RWUM[0xE];                                   // 0x004A(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_R6MM[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0050(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0051(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_2MKA[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	...
	{
	public:
		int32_t                                                    NumberOfPieces;                                          // 0x0138(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_Y4SH[0x4];                                   // 0x0144(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6L8S[0x18];                                  // 0x01E0(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		class FScriptDelegate                                      OnGenerateWidgetEvent;                                   // 0x0148(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_7CAW[0x18];                                  // 0x0158(0x0018) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x04E8 (FullSize[0x0620] - InheritedSize[0x0138])
	 */
	class UComboBoxString : public UWidget
	{
	public:
		TArray<class FString>                                      DefaultOptions;                                          // 0x0138(0x0010) Edit, ZeroConstructor
		class FString                                              SelectedOption;                                          // 0x0148(0x0010) Edit, ZeroConstructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_Z6CO[0x3];                                   // 0x0595(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      OnGenerateWidgetEvent;                                   // 0x0598(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		class FScriptMulticastDelegate                             OnSelectionChanged;                                      // 0x05A8(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnOpening;                                               // 0x05B8(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_W446[0x58];                                  // 0x05C8(0x0058) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0390 (FullSize[0x04C8] - InheritedSize[0x0138])
	 */
	class UEditableText : public UWidget
	{
	public:
		class FText                                                Text;                                                    // 0x0138(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_G0BO[0x20];                                  // 0x0150(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FScriptDelegate                                      TextDelegate;                                            // 0x0170(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		class FText                                                HintText;                                                // 0x0180(0x0018) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, BlueprintReadOnly
		unsigned char                                              UnknownData_WOGM[0x20];                                  // 0x0198(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FScriptDelegate                                      HintTextDelegate;                                        // 0x01B8(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		unsigned char                                              UnknownData_6VGY[0x2];                                   // 0x0482(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WYGB[0x3];                                   // 0x048D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnTextChanged;                                           // 0x0490(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnTextCommitted;                                         // 0x04A0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_68JK[0x18];                                  // 0x04B0(0x0018) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x09C0 (FullSize[0x0AF8] - InheritedSize[0x0138])
	 */
	class UEditableTextBox : public UWidget
	{
	public:
		class FText                                                Text;                                                    // 0x0138(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_KR6W[0x20];                                  // 0x0150(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FScriptDelegate                                      TextDelegate;                                            // 0x0170(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		class FText                                                HintText;                                                // 0x09E8(0x0018) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, BlueprintReadOnly
		unsigned char                                              UnknownData_XX08[0x20];                                  // 0x0A00(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FScriptDelegate                                      HintTextDelegate;                                        // 0x0A20(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		unsigned char                                              UnknownData_UMI5[0x2];                                   // 0x0AA2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R302[0x3];                                   // 0x0ABD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnTextChanged;                                           // 0x0AC0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnTextCommitted;                                         // 0x0AD0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_K8NO[0x18];                                  // 0x0AE0(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UIP9[0x8];                                   // 0x0138(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       bIsExpanded;                                             // 0x0140(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_9NCB[0x3];                                   // 0x0141(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnExpansionChanged;                                      // 0x0158(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		...
		unsigned char                                              UnknownData_KGO3[0x18];                                  // 0x0178(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		class FScriptDelegate                                      BrushDelegate;                                           // 0x01D0(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		class FScriptDelegate                                      ColorAndOpacityDelegate;                                 // 0x01F0(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		class FScriptDelegate                                      OnMouseButtonDownEvent;                                  // 0x0200(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_84GA[0x18];                                  // 0x0210(0x0018) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0218 (FullSize[0x0350] - InheritedSize[0x0138])
	 */
	class UMultiLineEditableText : public UWidget
	{
	public:
		class FText                                                Text;                                                    // 0x0138(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_OPWD[0x20];                                  // 0x0150(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		struct FTextBlockStyle                                     WidgetStyle;                                             // 0x0170(0x0160) Edit, BlueprintVisible
		ETextJustify                                               Justification;                                           // 0x02D0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       bAutoWrapText;                                           // 0x02D1(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_R1Z3[0x2];                                   // 0x02D2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnTextChanged;                                           // 0x0318(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnTextCommitted;                                         // 0x0328(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_K9ML[0x18];                                  // 0x0338(0x0018) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0AB0 (FullSize[0x0BE8] - InheritedSize[0x0138])
	 */
	class UMultiLineEditableTextBox : public UWidget
	{
	public:
		class FText                                                Text;                                                    // 0x0138(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_KKJ7[0x20];                                  // 0x0150(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		ETextJustify                                               Justification;                                           // 0x0B38(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       bAutoWrapText;                                           // 0x0B39(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_QDRA[0x2];                                   // 0x0B3A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnTextChanged;                                           // 0x0BB0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnTextCommitted;                                         // 0x0BC0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_4RIJ[0x18];                                  // 0x0BD0(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZAJP[0x18];                                  // 0x0138(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XPW2[0x8];                                   // 0x0148(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XS5X[0x18];                                  // 0x0150(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		class FScriptDelegate                                      ContentColorAndOpacityDelegate;                          // 0x0160(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		struct FMargin                                             Padding;                                                 // 0x0170(0x0010) Edit, BlueprintVisible, BlueprintReadOnly
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0180(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0181(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_JO8G[0x6];                                   // 0x0182(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSlateBrush                                         Background;                                              // 0x0188(0x0090) Edit, BlueprintVisible, BlueprintReadOnly
		class FScriptDelegate                                      BackgroundDelegate;                                      // 0x0218(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		class FScriptDelegate                                      BrushColorDelegate;                                      // 0x0238(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		unsigned char                                              UnknownData_WEC3[0x3];                                   // 0x0249(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      OnMouseButtonDownEvent;                                  // 0x024C(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		class FScriptDelegate                                      OnMouseButtonUpEvent;                                    // 0x025C(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		class FScriptDelegate                                      OnMouseMoveEvent;                                        // 0x026C(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		class FScriptDelegate                                      OnMouseDoubleClickEvent;                                 // 0x027C(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_B0GZ[0x1C];                                  // 0x028C(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	/**
	 * Class UMG.Button
	 * Size -> 0x0320 (FullSize[0x0470] - InheritedSize[0x0150])
	 */
	...
	public:
		...
		EButtonClickMethod                                         ClickMethod;                                             // 0x0420(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash
		EButtonTouchMethod                                         TouchMethod;                                             // 0x0421(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash
		bool                                                       IsFocusable;                                             // 0x0422(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_E2YE[0x5];                                   // 0x0423(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnClicked;                                               // 0x0428(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnPressed;                                               // 0x0438(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnReleased;                                              // 0x0448(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_LFA1[0x18];                                  // 0x0458(0x0018) MISSED OFFSET (PADDING)
	...
	/**
	 * Class UMG.CheckBox
	 * Size -> 0x06C8 (FullSize[0x0818] - InheritedSize[0x0150])
	 */
	class UCheckBox : public UContentWidget
	{
	public:
		ECheckBoxState                                             CheckedState;                                            // 0x0150(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_BVGW[0x3];                                   // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      CheckedStateDelegate;                                    // 0x0154(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_H2CN[0x4];                                   // 0x0164(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x07A8(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_1D2Q[0x3];                                   // 0x07A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FMargin                                             Padding;                                                 // 0x07AC(0x0010) Deprecated
		unsigned char                                              UnknownData_VAJL[0x4];                                   // 0x07BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSlateColor                                         BorderBackgroundColor;                                   // 0x07C0(0x0030) Deprecated
		class FScriptMulticastDelegate                             OnCheckStateChanged;                                     // 0x07F0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_P6UQ[0x18];                                  // 0x0800(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QHXU[0x1F];                                  // 0x0151(0x001F) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0048 (FullSize[0x0198] - InheritedSize[0x0150])
	 */
	...
	public:
		...
		class FScriptDelegate                                      OnGetMenuContentEvent;                                   // 0x0158(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		EMenuPlacement                                             Placement;                                               // 0x0168(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_NVGU[0x7];                                   // 0x0169(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnMenuOpenChanged;                                       // 0x0170(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_E76W[0x18];                                  // 0x0180(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_98ZV[0x18];                                  // 0x0150(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TX6F[0x18];                                  // 0x0150(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		EStretchDirection                                          StretchDirection;                                        // 0x0150(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EStretch                                                   Stretch;                                                 // 0x0151(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_2100[0x2];                                   // 0x0152(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KUV3[0x18];                                  // 0x0158(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_C9LC[0x3];                                   // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I98M[0x1C];                                  // 0x016C(0x001C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_98XA[0x30];                                  // 0x0160(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T5QW[0x18];                                  // 0x0170(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UEBP[0x18];                                  // 0x0150(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EOO0[0x18];                                  // 0x0150(0x0018) MISSED OFFSET (PADDING)
	...
	/**
	 * Class UMG.ScrollBox
	 * Size -> 0x07A0 (FullSize[0x08F0] - InheritedSize[0x0150])
	 */
	...
	public:
		...
		EOrientation                                               Orientation;                                             // 0x08C0(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ESlateVisibility                                           ScrollBarVisibility;                                     // 0x08C1(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		EConsumeMouseWheel                                         ConsumeMouseWheel;                                       // 0x08C2(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_1S74[0x1];                                   // 0x08C3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JPBO[0x23];                                  // 0x08CD(0x0023) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_487O[0x18];                                  // 0x0168(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_55X2[0x18];                                  // 0x0150(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		int32_t                                                    ActiveWidgetIndex;                                       // 0x0150(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_EAD6[0x1C];                                  // 0x0154(0x001C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9RJC[0x18];                                  // 0x0158(0x0018) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0228 (FullSize[0x0360] - InheritedSize[0x0138])
	 */
	...
	public:
		...
		EProgressBarFillType                                       BarFillType;                                             // 0x0314(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       bIsMarquee;                                              // 0x0315(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_124L[0x2];                                   // 0x0316(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      PercentDelegate;                                         // 0x0318(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		class FScriptDelegate                                      FillColorAndOpacityDelegate;                             // 0x0338(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_KV3Y[0x18];                                  // 0x0348(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		class FText                                                Text;                                                    // 0x0138(0x0018) ELEMENT_SIZE_MISMATCH Edit, Protected
		unsigned char                                              UnknownData_8I1J[0x20];                                  // 0x0150(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FScriptDelegate                                      TextDelegate;                                            // 0x0170(0x0010) ZeroConstructor, InstancedReference, NoDestructor, Protected
		...
		ETextJustify                                               Justification;                                           // 0x01D0(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_O7Z4[0x2];                                   // 0x01D2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2ZKM[0x4];                                   // 0x01EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7T9O[0x178];                                 // 0x0200(0x0178) MISSED OFFSET (PADDING)
	...
	/**
	 * Class UMG.ScrollBar
	 * Size -> 0x0548 (FullSize[0x0680] - InheritedSize[0x0138])
	 */
	...
	public:
		...
		EOrientation                                               Orientation;                                             // 0x0659(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_0CLI[0x2];                                   // 0x065A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector2D                                           Thickness;                                               // 0x065C(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_GQIK[0x1C];                                  // 0x0664(0x001C) MISSED OFFSET (PADDING)
	...
	/**
	 * Class UMG.Slider
	 * Size -> 0x02D0 (FullSize[0x0408] - InheritedSize[0x0138])
	 */
	class USlider : public UWidget
	{
	public:
		float                                                      Value;                                                   // 0x0138(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class FScriptDelegate                                      ValueDelegate;                                           // 0x013C(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_1G3E[0x4];                                   // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSliderStyle                                        WidgetStyle;                                             // 0x0150(0x0248) Edit, BlueprintVisible
		EOrientation                                               Orientation;                                             // 0x0398(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_YV5Q[0x3];                                   // 0x0399(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_H6OY[0x2];                                   // 0x03BE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnMouseCaptureBegin;                                     // 0x03C0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnMouseCaptureEnd;                                       // 0x03D0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnValueChanged;                                          // 0x03E0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_QPO7[0x18];                                  // 0x03F0(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EMZI[0x18];                                  // 0x0140(0x0018) MISSED OFFSET (PADDING)
	...
	/**
	 * Class UMG.SpinBox
	 * Size -> 0x0428 (FullSize[0x0560] - InheritedSize[0x0138])
	 */
	...
	public:
		float                                                      Value;                                                   // 0x0138(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class FScriptDelegate                                      ValueDelegate;                                           // 0x013C(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_2PWP[0x4];                                   // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RG35[0x2];                                   // 0x04BE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSlateColor                                         ForegroundColor;                                         // 0x04C0(0x0030) Edit, BlueprintVisible, BlueprintReadOnly
		class FScriptMulticastDelegate                             OnValueChanged;                                          // 0x04F0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnValueCommitted;                                        // 0x0500(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnBeginSliderMovement;                                   // 0x0510(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnEndSliderMovement;                                     // 0x0520(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		...
		unsigned char                                              UnknownData_F8H7[0x3];                                   // 0x0531(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1I6X[0x1C];                                  // 0x0544(0x001C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8EGJ[0x4];                                   // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UObject*>                                     Items;                                                   // 0x0140(0x0010) Edit, BlueprintVisible, ZeroConstructor
		ESelectionMode                                             SelectionMode;                                           // 0x0150(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_NP36[0x3];                                   // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      OnGenerateRowEvent;                                      // 0x0154(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_USI8[0x1C];                                  // 0x0164(0x001C) MISSED OFFSET (PADDING)
	...
	public:
		...
		TArray<class UObject*>                                     Items;                                                   // 0x0140(0x0010) Edit, BlueprintVisible, ZeroConstructor
		ESelectionMode                                             SelectionMode;                                           // 0x0150(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_U0BI[0x3];                                   // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      OnGenerateTileEvent;                                     // 0x0154(0x0010) Edit, ZeroConstructor, InstancedReference, NoDestructor
		unsigned char                                              UnknownData_3560[0x1C];                                  // 0x0164(0x001C) MISSED OFFSET (PADDING)
	...
	public:
		...
		class FText                                                Text;                                                    // 0x0140(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_11TM[0x20];                                  // 0x0158(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FScriptDelegate                                      TextDelegate;                                            // 0x0178(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		struct FSlateColor                                         ColorAndOpacity;                                         // 0x0188(0x0030) Edit, BlueprintVisible, BlueprintReadOnly
		class FScriptDelegate                                      ColorAndOpacityDelegate;                                 // 0x01B8(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		...
		class FScriptDelegate                                      ShadowColorAndOpacityDelegate;                           // 0x0220(0x0010) ZeroConstructor, InstancedReference, NoDestructor
		ETextJustify                                               Justification;                                           // 0x0230(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       AutoWrapText;                                            // 0x0231(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_53ZD[0x2];                                   // 0x0232(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2TYU[0x18];                                  // 0x0250(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EREQ[0x1];                                   // 0x013F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K1FM[0x18];                                  // 0x01D8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		class FScriptMulticastDelegate                             OnAnimationStarted;                                      // 0x02A8(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnAnimationFinished;                                     // 0x02B8(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
	...
	public:
		...
		TArray<class FName>                                        NamedSlots;                                              // 0x0250(0x0010) ZeroConstructor
	 ...
	 * Size -> 0x00F8 (FullSize[0x06B0] - InheritedSize[0x05B8])
	 */
	class UWidgetComponent : public UPrimitiveComponent
	{
	public:
		unsigned char                                              UnknownData_Q4K7[0x8];                                   // 0x05B8(0x0008) Fix Super Size
		class UClass*                                              WidgetClass;                                             // 0x05C0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash
		struct FIntPoint                                           DrawSize;                                                // 0x05C8(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		struct FVector2D                                           Pivot;                                                   // 0x05D0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		float                                                      MaxInteractionDistance;                                  // 0x05D8(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		unsigned char                                              UnknownData_GNXK[0x4];                                   // 0x05DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ULocalPlayer*                                        OwnerPlayer;                                             // 0x05E0(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		struct FLinearColor                                        BackgroundColor;                                         // 0x05E8(0x0010) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		EWidgetBlendMode                                           BlendMode;                                               // 0x05F8(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		bool                                                       bIsOpaque;                                               // 0x05F9(0x0001) ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected
		bool                                                       bIsTwoSided;                                             // 0x05FA(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_DATQ[0x1];                                   // 0x05FB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      ParabolaDistortion;                                      // 0x05FC(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		bool                                                       TickWhenOffscreen;                                       // 0x0600(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_JAZQ[0x7];                                   // 0x0601(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UUserWidget*                                         Widget;                                                  // 0x0608(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UBodySetup*                                          BodySetup;                                               // 0x0610(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInterface*                                  TranslucentMaterial;                                     // 0x0618(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInterface*                                  TranslucentMaterial_OneSided;                            // 0x0620(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInterface*                                  OpaqueMaterial;                                          // 0x0628(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInterface*                                  OpaqueMaterial_OneSided;                                 // 0x0630(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInterface*                                  MaskedMaterial;                                          // 0x0638(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInterface*                                  MaskedMaterial_OneSided;                                 // 0x0640(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UTextureRenderTarget2D*                              RenderTarget;                                            // 0x0648(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		class UMaterialInstanceDynamic*                            MaterialInstance;                                        // 0x0650(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash
		bool                                                       bUseLegacyRotation;                                      // 0x0658(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		bool                                                       bAddedToScreen;                                          // 0x0659(0x0001) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_ELCB[0x56];                                  // 0x065A(0x0056) MISSED OFFSET (PADDING)
