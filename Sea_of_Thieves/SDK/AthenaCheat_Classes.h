...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MCBW[0x28];                                  // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UUZI[0x64];                                  // 0x00D4(0x0064) MISSED OFFSET (PADDING)

	public:
		void WindTriggerChange(int32_t ChangeInstantly);
		...
		void Walk();
		void VomitWithType(const class FName& VomitType, float Duration);
		void Vomit();
		...
		void UnlockAllEntitlements(int32_t TrueFalse);
		void UnlockAllEmblemsAndAchievements();
		void UnBreakLeg();
		void TutorialAction(const class FString& ActionTypeString);
		void TriggerRewardNotification(class FName* Identifier);
		void TriggerLandmarkReaction(int32_t ActionType);
		...
		void TriggerControllerConnectionChange(bool IsConnect, int32_t UserId, int32_t ControllerId);
		...
		void TeleportPlayerToSpireLocation(int32_t SpireIndex);
		...
		void TeleportActorToTrackedActorType(const class FString& ActorIdString, int32_t DestinationActorType);
		...
		void StartCargoRunFromNearestNPC(int32_t NumOfCrates);
		void StartCaptaincySessionAsNewCrew();
		void StartAshenLordGeysers();
		void StartAllVolcanos();
		void StartAllCrewVoyages();
		void SpireStreamOut(int32_t SpireIndex);
		void SpireStreamIn(int32_t SpireIndex);
		...
		void SpawnTinySharkAtLocation(float X, float Y, float Z, int32_t PartIndex);
		void SpawnTinySharkAtCurrentLocation(int32_t ControllerParamIndex, int32_t PartIndex);
		...
		void SpawnNumberOfAI(const class FString& AIDescString, int32_t NumToSpawn);
		void SpawnNightmareAggressiveGhostShipEncountersRandom();
		void SpawnNightmareAggressiveGhostShipEncountersNearToPlayer();
		void SpawnMultipleTreasureChestsOfType(class FString* ChestTypeString, int32_t Num);
		...
		void SinkShipWithKeelOverIndex(int32_t KeelOverConfigIndex);
		...
		void SetWaveFlag(int32_t InFlag);
		...
		void SetTimeHoursAndMinutes(int32_t Hours, int32_t Minutes);
		void SetTime(int32_t Hours);
		void SetTaleSelectorSeed(int32_t Seed);
		...
		void SetRitualTableRequiredPlayersOverride(int32_t RequiredPlayerCount);
		void SetPreventLeakingOnAllShips();
		void SetPreventLeakingOnAllDamageZones(bool PreventLeaking);
		void SetPlayerVisibleToAI();
		void SetPlayerMaxTicks(int32_t InMaxTicksPerFrame);
		...
		void SetMaxNumOfSpawnedAI(int32_t MaxNumOfSpawnedActors);
		void SetMaxMovingPetsOnShips(int32_t MaxMovingPets);
		void SetMaxMovingPetsOnServer(int32_t MaxMovingPets);
		void SetMaxMovingPetsOnLand(int32_t MaxMovingPets);
		...
		void SetGlitterbeardRequiredPlayersOverride(int32_t RequiredPlayerCount);
		void SetFOV(float InNewFOV);
		void SetForceLocalPlayerMoveForwardFlipDistance(float FlipDistance);
		void SetFlameOfFateColour(int32_t InFlameOfFateType);
		void SetFactionStreak(int32_t InStreak);
		void SetDebugItemSource(const class FString& Source);
		void SetDebugHealthStage(int32_t InStage);
		...
		void SetCoordinatedKrakenPhaseAsset(int32_t AssetIndex);
		...
		void RemoveItemInSlot(int32_t SlotIndex);
		...
		void RebuildPirateFromSeed(int32_t Seed);
		void ReallyScrambleMyGamertag();
		void QueryShipStocks();
		void Puzzle_UnlockLockByIndex(const class FString& TargetActor, int32_t LockIndex);
		...
		void PlayerAnimationOverride(const class FName& Name);
		void OverrideShipPartFromCatalogue(const class FString& InShipActorIdConsoleString, int32_t InCataloguePartIndex, int32_t InCataloguePartCustomisationIndex);
		...
		void IPGOverride(const class FName& BodyShape, float Distance);
		...
		void IncrementTime(int32_t Hours, int32_t Minutes);
		void IncrementFactionStreak();
		void IncrementDebugHealthStage();
		void IncreaseEmissaryCount(int32_t Amount);
		...
		void HandInMegalodonSoulToRitualTable(int32_t SoulType);
		void God();
		...
		void ForcePetHangout(const class FName& HangoutName, int32_t PositionIndex);
		void ForceOpenShop();
		void ForceNPCOnSurfaceToMove(bool FastMove, bool KeepCurrentLocation);
		void ForceNPCOnSurfaceLocation(int32_t LoctationIndex, int32_t LoctationPointIndex);
		...
		void ForceEmoteWithEmoteProp(const class FName& EmoteIdentifier, const class FString& EmotePropAssetLocation);
		void ForceEmoteWithDescriptionAndEmoteProp(const class FName& EmoteIdentifier, const class FString& DisplayName, const class FString& AudioDescription, const class FString& EmotePropAssetLocation);
		void ForceEmoteWithDescription(const class FName& EmoteIdentifier, const class FString& DisplayName, const class FString& AudioDescription);
		void ForceEmote(const class FName& EmoteIdentifier);
		void ForceCloseShop();
		...
		void Fly();
		void FloodShipWithKeelOverIndex(float NormalisedWaterAmount, int32_t KeelOverConfigIndex);
		void FloodShip(float NormalisedWaterAmount);
		void FireStartedCaptainedSessionEvent();
		void FireSeasonRewardEarnedMessage(int32_t InNumSeason, int32_t InRewardsLevel, bool InMultipleRewards);
		void FireSeasonGoalProgressionMessage(int32_t InNumSeason, int32_t InPreviousProgress, int32_t InCurrentProgress, int32_t InCompletionTreshold, int32_t InGoalType, const class FString& InGoalCategory);
		void FireSeasonGoalCompletionMessage(int32_t InNumSeason, int32_t InGoalType, const class FString& InGoalCategory);
		void FireLevelCompletionMessage(int32_t InNumSeason, int32_t InLevel, int32_t InTimeSpentInLevel, int32_t InTier, int32_t InTimeSpentInTier, bool InTierCompleted, bool InSeasonCompleted);
		void FireCreatorCrewSignedUpStat();
		void FireCreatorCrewMinutesViewedStat(int32_t InNumMinutes);
		void FireCreatorCrewMinutesStreamedStat(int32_t InNumMinutes);
		void FireCreatorCrewCurrentViewersStat(int32_t InNumViewers);
		...
		void EnableSelectShipwreckLocationFromValidCandidatesDebugDisplay(int32_t TrueFalse);
		void EnableNTP(bool Enable);
		void EnableMermaidSpawning(int32_t Enable);
		void EnableMermaidDeletion(int32_t Enable);
		...
		void EnableBeaconOnAllMermaids(int32_t Enable);
		...
		void DrawTreasureDebug(int32_t Enabled);
		...
		void DisplaySpireLocationsDebug(int32_t Enabled);
		...
		void DisplayFallDamageDebug(int32_t Enable);
		...
		void DespawnNumberOfAI(const class FString& AITypeString, int32_t NumToDespawn);
		void DespawnFirstAI();
		...
		void CoordinatedKrakenEnableDebugging(int32_t Enable);
		...
		void AddPetForPlayer(int32_t PetTypeIndex, int32_t PetPartIndex);
		void AddPetForAllPlayers(int32_t PetTypeIndex, int32_t PetPartIndex);
		...
		void AddDrunkenness(int32_t DrunkennessType, float DrunkennessChange);
