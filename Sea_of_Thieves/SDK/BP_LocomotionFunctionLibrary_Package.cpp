...
namespace CG
{
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_DriveValueToClampByDelta(float* Value, float Min, float Max, float Delta, class UObject* __WorldContext, bool* Hit_Min, bool* Hit_Max)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.DriveValueToClampByDelta");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_FindSailControlHandIKPositionFromAnimation(const struct FVector& Animation_Hand_IK_Location, const struct FVector& LowerRopeLocation, const struct FVector& UpperRopeLocation, class UObject* __WorldContext, struct FVector* Location_On_Rope)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.FindSailControlHandIKPositionFromAnimation");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_ArrayLoadingFromDataDrivenBlendSpace(TArray<class UBlendSpace*>* TargetArrayBlendspace, TArray<class UBlendSpace*>* LoadedArrayDataBlendspace, class UBlendSpace* FallbackBlendspace, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.ArrayLoadingFromDataDrivenBlendSpace");
	 ...
	 * 		Flags  -> (Static, Public, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		TArray<class UBlendSpace1D*>                       TargetArray_D                                              (Parm, OutParm, ZeroConstructor, ReferenceParm)
	 * 		TArray<class UBlendSpace1D*>                       LoadedArrayData_D                                          (Parm, OutParm, ZeroConstructor, ReferenceParm)
	 * 		class UBlendSpace1D*                               FallbackBlendspace1D                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_ArrayLoadingFromDataDriven1DBlendSpace(TArray<class UBlendSpace1D*>* TargetArray_D, TArray<class UBlendSpace1D*>* LoadedArrayData_D, class UBlendSpace1D* FallbackBlendspace1D, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.ArrayLoadingFromDataDriven1DBlendSpace");
		...
		if (TargetArray_D != nullptr)
			*TargetArray_D = params.TargetArray_D;
		if (LoadedArrayData_D != nullptr)
			*LoadedArrayData_D = params.LoadedArrayData_D;
	}
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_ArrayLoadingFromDataDriven(TArray<class UAnimSequence*>* TargetArray, TArray<class UAnimSequence*>* LoadedArrayData, class UAnimSequence* FallBackAnimation, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.ArrayLoadingFromDataDriven");
	 ...
	 * 		EIKLimbName                                        Limb_ID                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		bool                                               Active                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		ELimbIKSpace                                       Coordinate_Space                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 ...
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_Update_IK_Limb_Controls(class USkeletalMeshComponent* SkeletalMeshComponent, EIKLimbName Limb_ID, bool Active, ELimbIKSpace Coordinate_Space, float Translation_Strength, float Rotation_Strength, const struct FTransform& Transform, float BlendIn, float BlendOut, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Update IK Limb Controls");
	 ...
	 * 		Flags  -> (Static, Public, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		int32_t                                            Value                                                      (Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor)
	 * 		int32_t                                            Decrement                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_Decrement_Integer(int32_t* Value, int32_t Decrement, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Decrement Integer");
	 ...
	 * 		Flags  -> (Static, Public, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		int32_t                                            integer                                                    (Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor)
	 * 		int32_t                                            Increment                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_Increment_Integer(int32_t* integer, int32_t Increment, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Increment Integer");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Calculate_Turn_Times(bool TurnLeft, float CurrentControllerYaw, float* PreviousControllerYaw, struct FBP_Turning* Turning, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Calculate Turn Times");
	...
	bool UBP_LocomotionFunctionLibrary_C::STATIC_InRangeAndRate(bool InZone, float Min, float Max, struct FBP_Turning* Turning, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.InRangeAndRate");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Turn_State_Change_Check(struct FBP_Turning* Turning, bool InZone, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Turn State Change Check");
	...
	bool UBP_LocomotionFunctionLibrary_C::STATIC_Not_In_Range(float Value, float Min, float Max, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Not In Range");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Update_Animation_Turn_State(struct FBP_Turning* Turning, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Update Animation Turn State");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Update_Animation_Turn_Time(bool TurningLeft, float* CurrentTurnAngle, float Reset_Angle, float* Previous_Controller_Yaw, float Current_Controller_Yaw, float* Animation_Time, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Update Animation Turn Time");
	 ...
	 * 		EJumping                                           JumpingState                                               (Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor)
	 ...
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_JumpingLogic(class ACharacter* PlayerCharacter, float MovementSpeed, float FrameDelta, float* JumpImpactTimerMax, EJumping* JumpingState, float* PreImpactTime, float* JumpImpactTimer, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.JumpingLogic");
	 ...
	 * 		EEasingFunc                                        EaseingType                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 ...
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_Ik_Blending(float* BlendCounter, bool IKON, float* Translation_Strength, float* Rotation_Strength, EEasingFunc EaseingType, float BlendMax, float FrameDeltaTime, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Ik Blending");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Increment_Counter(float Counter, float CounterMax, float DeltaTime, class UObject* __WorldContext, bool* Hit_Max_Count, float* IncrementedCounter)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Increment Counter");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Decrement_Counter(float Counter, float CounterMin, float DeltaTime, class UObject* __WorldContext, bool* Hit_Min_Count, float* DecrementedCounter)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Decrement Counter");
	 ...
	 * 		EEasingFunc                                        EasingType                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		class UObject*                                     __WorldContext                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		float                                              Return_Val                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBP_LocomotionFunctionLibrary_C::STATIC_Out_Over_Time(float CurrentTime, float MaxTime, EEasingFunc EasingType, class UObject* __WorldContext, float* Return_Val)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Out Over Time");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Update_Animation_Times(bool TurningLeft, float Current_Controller_Yaw, float* Previous_Controller_Yaw, struct FBP_Turning* Turning, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Update Animation Times");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Update_Turn_Animations(bool TurningLeft, float CurrentYaw, float PreviousYaw, float FrameDeltaTime, struct FBP_Turning* Turning, class UObject* __WorldContext)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Update Turn Animations");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Fix_Yaw_Wraparound(float CurrentYaw, float PreviousYaw, class UObject* __WorldContext, float* NewPreviousYaw)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Fix Yaw Wraparound");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_ReflexAngleCheck(float Direction_A, float Direction_B, class UObject* __WorldContext, bool* ReflexAngle)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.ReflexAngleCheck");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_ControllerRotation(class ACharacter* Character, class UObject* __WorldContext, float* Pitch, float* Yaw)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.ControllerRotation");
	...
	void UBP_LocomotionFunctionLibrary_C::STATIC_Character_Speed(class ACharacter* Character, class UObject* __WorldContext, struct FVector* Velocity, float* Speed)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C.Character Speed");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_LocomotionFunctionLibrary_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UBP_LocomotionFunctionLibrary_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_LocomotionFunctionLibrary.BP_LocomotionFunctionLibrary_C");
		return ptr;
	}
