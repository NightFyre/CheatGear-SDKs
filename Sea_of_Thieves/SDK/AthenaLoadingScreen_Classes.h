...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PUZY[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    MaxNumImagesPerLoad;                                     // 0x0090(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_DWNR[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                SpinnerText;                                             // 0x0098(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_SAEW[0x20];                                  // 0x00B0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		int32_t                                                    NumTipsPerImage;                                         // 0x0184(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_55YH[0x4];                                   // 0x01CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FText>                                        LoadingScreenTips;                                       // 0x01D0(0x0010) Edit, ZeroConstructor
		...
		unsigned char                                              UnknownData_TVX9[0x7];                                   // 0x0211(0x0007) MISSED OFFSET (PADDING)
