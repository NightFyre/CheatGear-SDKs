...
namespace CG
{
	 ...
	 * Size -> 0x0770 (FullSize[0x0E50] - InheritedSize[0x06E0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_CCQ1[0x8];                                   // 0x0AA8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void ExecuteUbergraph_BP_Humanoid_Preview(int32_t EntryPoint);
